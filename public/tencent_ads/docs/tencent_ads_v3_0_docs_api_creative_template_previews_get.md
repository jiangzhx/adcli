...
| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | creative_template_previews/get |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/creative_template_previews/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| preview_url | string | 预览地址，有效时长为 1h |
