...
source_url: https://developers.e.qq.com/v3.0/docs/api/local_stores_address_parsing_result/get
doc_id: tencent_ads_v3_0_docs_api_local_stores_address_parsing_result_get
source_id: tencent_ads_v3_0_docs_api_local_stores_address_parsing_result_get
---
# 解析门店地址 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
```
curl 'https://api.e.qq.com/v3.0/local_stores_address_parsing_result/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| success_list | struct[] | 门店 poi 列表信息 |
| poi_id | string | poi id |
| origin_address | string | 门店地址 |
