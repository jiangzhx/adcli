---
title: 批量修改营销单元出价 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/adgroups/update_bid_amount
doc_id: tencent_ads_v3_0_docs_api_adgroups_update_bid_amount
source_id: tencent_ads_v3_0_docs_api_adgroups_update_bid_amount
---
# 批量修改营销单元出价 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | adgroups/update_bid_amount |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/adgroups/update_bid_amount?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
