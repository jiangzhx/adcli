---
title: 获取元素申诉复审结果 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/element_appeal_review/get
doc_id: tencent_ads_v3_0_docs_api_element_appeal_review_get
source_id: tencent_ads_v3_0_docs_api_element_appeal_review_get
---
# 获取元素申诉复审结果 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
| element_finger_print | string | 元素指纹 |
...
| appeal_status | enum | 申诉状态，[\[枚举详情\]](https://developers.e.qq.com/v3.0/docs/enums#appeal_status) |
| description | string | 详细描述 |
| image_list | string[] | 附件图片列表 |
| reply_image_url_list | string[] | 申诉复审回复的图片地址列表 |
