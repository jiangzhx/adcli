...
source_url: https://developers.e.qq.com/v3.0/docs/api/wallet/get
doc_id: tencent_ads_v3_0_docs_api_wallet_get
source_id: tencent_ads_v3_0_docs_api_wallet_get
---
# 获取钱包信息 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
```
curl -v -G 'https://api.e.qq.com/v3.0/wallet/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
