---
title: 编辑共享钱包基础信息 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/wallet_edit/add
doc_id: tencent_ads_v3_0_docs_api_wallet_edit_add
source_id: tencent_ads_v3_0_docs_api_wallet_edit_add
---
# 编辑共享钱包基础信息 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | account_management |
| --- | --- |
| 请求地址 | wallet_edit/add |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/wallet_edit/add?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
-H 'Content-Type: application/json' \
-d '{
    "wallet_id": 24150059,
    "account_id": "<ACCOUNT_ID>",
    "wallet_name": "测试钱包-edit",
    "tag_list": [
        "tag-edit-1",
        "tag-edit-2"
    ],
    "contact_info_list": [
        {
            "avatar_name": "contact-edit-1",
            "contact": "1920000001",
            "status": 0
        },
        {
            "avatar_name": "contact-edit-2",
            "contact": "19200000002",
            "status": 1
        }
    ],
