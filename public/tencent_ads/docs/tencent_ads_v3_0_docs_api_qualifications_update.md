...
source_url: https://developers.e.qq.com/v3.0/docs/api/qualifications/update
doc_id: tencent_ads_v3_0_docs_api_qualifications_update
source_id: tencent_ads_v3_0_docs_api_qualifications_update
---
# 更新客户资质 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
```
curl 'https://api.e.qq.com/v3.0/qualifications/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
