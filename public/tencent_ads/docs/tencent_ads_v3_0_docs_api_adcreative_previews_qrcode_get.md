...
| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | adcreative_previews_qrcode/get |
| 请求方法 | GET |
...
```
curl -v -G 'https://api.e.qq.com/v3.0/adcreative_previews_qrcode/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
