...
source_url: https://developers.e.qq.com/v3.0/docs/api/product_items/batch_update
doc_id: tencent_ads_v3_0_docs_api_product_items_batch_update
source_id: tencent_ads_v3_0_docs_api_product_items_batch_update
---
# 批量更新商品信息 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | product_items/batch_update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/product_items/batch_update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
