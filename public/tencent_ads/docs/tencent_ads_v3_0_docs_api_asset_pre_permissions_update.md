...
source_url: https://developers.e.qq.com/v3.0/docs/api/asset_pre_permissions/update
doc_id: tencent_ads_v3_0_docs_api_asset_pre_permissions_update
source_id: tencent_ads_v3_0_docs_api_asset_pre_permissions_update
---
# 资产预授权确认 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | asset_pre_permissions/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/asset_pre_permissions/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
