...
source_url: https://developers.e.qq.com/v3.0/docs/api/local_stores_search_info/get
doc_id: tencent_ads_v3_0_docs_api_local_stores_search_info_get
source_id: tencent_ads_v3_0_docs_api_local_stores_search_info_get
---
# 搜索门店 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
| key_word* | string | 关键词 字段长度最小 1 字节，长度最大 128 字节 |
| page | integer | 搜索页码 最小值 1，最大值 99999 默认值：1 |
| page_size | integer | 一页显示的数据条数 最小值 1，最大值 20 |

## 请求示例

```
curl -v -G 'https://api.e.qq.com/v3.0/local_stores_search_info/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
```
{
    ...
    "data": {
        "list": [
            {
                "poi_id": "7334967656608876089",
                "local_store_name": "聚宝源熟食",
                "local_store_address": "北京市西城区牛街 5-2 号",
                "local_store_category": "美食:火锅",
                "local_store_province": "北京市",
                "local_store_city": "北京市"
            }
        ],
        "page_info": {
            "page": 1,
