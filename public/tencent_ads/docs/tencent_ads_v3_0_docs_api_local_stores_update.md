...
source_url: https://developers.e.qq.com/v3.0/docs/api/local_stores/update
doc_id: tencent_ads_v3_0_docs_api_local_stores_update
source_id: tencent_ads_v3_0_docs_api_local_stores_update
---
# 更新门店信息 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | local_stores/update |
| 请求方法 | POST |
...
| local_store_list* | struct[] | 批量更新门店 poi 列表信息 数组最大长度 100 |
...
```
curl 'https://api.e.qq.com/v3.0/local_stores/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
-H 'Content-Type: application/json' \
-d '{
    "local_store_list": [
        {
            "poi_id": "15336847776077850441",
            "local_store_biz_info": {
                "customer_per_cost": 50,
                "customer_profile": [],
                "good_review_count": 0,
                "good_review_rate": 0,
                "hide_poi": false,
                ...
                "opening_hours": [
                    {
                        "date": "WORKDAY",
                        "time_series": "000000000000000000111111000011111111110000000000"
                    }
                ],
            ...
            "is_use_standardized_name": false
        }
    ],
        ...
        "list": [
            {
                "dianping_id": "",
                "is_use_standardized_name": false,
                "local_store_address": "深南大道 10000 号",
                "local_store_biz_info": {
                    "customer_per_cost": 50,
                    "customer_profile": {
                        "age": [],
                ...
                "local_store_name": "腾讯大厦",
                "local_store_province": "广东省",
                "local_store_street": "深南大道",
                "poi_id": "15336847776077850441",
                "wechat_customer_service_link": "",
                "wechat_ecosystem_accounts": {
                    "wechat_channels_id": "",
