...
source_url: https://developers.e.qq.com/v3.0/docs/api/wechat_channels_authorization/update
doc_id: tencent_ads_v3_0_docs_api_wechat_channels_authorization_update
source_id: tencent_ads_v3_0_docs_api_wechat_channels_authorization_update
---
# 更新视频号授权 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | wechat_channels_authorization/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/wechat_channels_authorization/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
