...
---
# 获取素材计量治理指标数据 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
| is_penalized | integer | 是否治理，(1=是，0=否) |
| penalty_review_total | integer | 复审总量，该主体*政策集团*开户二级行业的治理口径复审总量 |
| penalty_review_reject_cnt | integer | 拒绝量，该主体*政策集团*开户二级行业的治理口径复审拒绝量 |
| penalty_reject_rate | string | 拒绝率，%，该主体*政策集团*开户二级行业的治理口径拒绝率 |
| penalty_unit_price | string | 计量组合单价，单位：元，该主体*政策集团*开户二级行业的治理单价 |
| penalty_amount | string | 应治理金额，单位：元，该主体*政策集团*开户二级行业对应的应治理金额 |
| penalty_uid_cnt | integer | 关联 uid 数量，该主体*政策集团*开户二级行业下涉及到计量治理的 uid 数量 |
| capped_reject_cnt | integer | 计量组合封顶拒绝量，该主体*政策集团*开户二级行业下封顶拒绝量 |
| final_penalty_amount | string | 实际治理金额，单位：元，该主体*政策集团*开户二级行业封顶后的最终治理金额 |
