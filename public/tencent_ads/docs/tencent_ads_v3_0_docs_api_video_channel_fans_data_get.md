...
source_url: https://developers.e.qq.com/v3.0/docs/api/video_channel_fans_data/get
doc_id: tencent_ads_v3_0_docs_api_video_channel_fans_data_get
source_id: tencent_ads_v3_0_docs_api_video_channel_fans_data_get
---
# 获取粉丝数据 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management,ads_insights,account_management,audience_management,user_actions |
| --- | --- |
| 请求地址 | video_channel_fans_data/get |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/video_channel_fans_data/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
