...
source_url: https://developers.e.qq.com/v3.0/docs/api/adgroups/update
doc_id: tencent_ads_v3_0_docs_api_adgroups_update
source_id: tencent_ads_v3_0_docs_api_adgroups_update
---
# 更新营销单元 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | adgroups/update |
| 请求方法 | POST |
...
-d '{
    ...
    "targeting": {
        ...
        "excluded_converted_audience": {
            "excluded_dimension": "EXCLUDED_DIMENSION_CAMPAIGN",
        ...
        "wechat_ad_behavior": {
            "actions": [
                "WECHAT_OFFICIAL_ACCOUNT_AD_LIKE"
            ]
        }
    },
    "scene_spec": {
