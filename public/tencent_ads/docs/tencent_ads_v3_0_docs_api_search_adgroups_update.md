...
source_url: https://developers.e.qq.com/v3.0/docs/api/search_adgroups/update
doc_id: tencent_ads_v3_0_docs_api_search_adgroups_update
source_id: tencent_ads_v3_0_docs_api_search_adgroups_update
---
# 更新营销单元 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | search_adgroups/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/search_adgroups/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
-d '{
    ...
    "optimization_goal": "OPTIMIZATIONGOAL_CANVAS_CLICK",
