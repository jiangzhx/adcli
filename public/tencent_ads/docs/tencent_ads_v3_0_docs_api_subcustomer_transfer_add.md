---
title: 同商务管家子客间转账 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/subcustomer_transfer/add
doc_id: tencent_ads_v3_0_docs_api_subcustomer_transfer_add
source_id: tencent_ads_v3_0_docs_api_subcustomer_transfer_add
---
# 同商务管家子客间转账 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | account_management |
| --- | --- |
| 请求地址 | subcustomer_transfer/add |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/subcustomer_transfer/add?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
