---
title: 获取游戏 App 特征 V6 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/game_feature_v6/get
doc_id: tencent_ads_v3_0_docs_api_game_feature_v6_get
source_id: tencent_ads_v3_0_docs_api_game_feature_v6_get
---
# 获取游戏 App 特征 V6 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | game_feature_v6/get |
| 请求方法 | GET |
...
```
curl -v -G 'https://api.e.qq.com/v3.0/game_feature_v6/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| marketing_target_type | enum | 营销对象类型，[\[枚举详情\]](https://developers.e.qq.com/v3.0/docs/enums#api_marketing_target_type) |
| marketing_target_detail_id | string | 推广内容资产详情 id |
| profit_mode_id | integer | 变现模式标签 id |
| game_type_id | integer | 游戏类型标签 id |
| game_play_id | integer | 核心玩法 id |
| game_sub_play_id_list | integer[] | 核心副玩法标签 id 列表 |
