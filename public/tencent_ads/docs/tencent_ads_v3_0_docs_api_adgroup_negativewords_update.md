...
source_url: https://developers.e.qq.com/v3.0/docs/api/adgroup_negativewords/update
doc_id: tencent_ads_v3_0_docs_api_adgroup_negativewords_update
source_id: tencent_ads_v3_0_docs_api_adgroup_negativewords_update
---
# 更新否定词 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | adgroup_negativewords/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/adgroup_negativewords/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
