---
title: 获取经销商聚合数据 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/video_channel_dealer_data/get
doc_id: tencent_ads_v3_0_docs_api_video_channel_dealer_data_get
source_id: tencent_ads_v3_0_docs_api_video_channel_dealer_data_get
---
# 获取经销商聚合数据 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
```
curl 'https://api.e.qq.com/v3.0/video_channel_dealer_data/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| dealer_info_list | struct[] | 经销商聚合数据列表 |
| dealer_id | integer | 经销商 id |
| dealer_name | string | 经销商名称 |
| date | integer | 时间，展示为 int 格式 20231101 |
| leads_cnt | integer | 线索总数 |
| showings_cnt | integer | 直播场次数量 |
