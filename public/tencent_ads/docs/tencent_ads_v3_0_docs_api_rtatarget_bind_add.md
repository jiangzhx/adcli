...
| Id* | integer | 待绑定的 id，可以是营销单元 id、账户 id，微信账户 id 若来自 mp 平台则需同时提供直客 UID 和子客 UID |
...
| IsMp | integer | 是否微信营销，1：是 0：否，TargetType 为 1 时请务必准确填写，TargetType 为 3 时可不填。当投放来自 mp 平台则选择“是”，来自 eqq 或者 adq 平台则选择“否” |
| UId* | integer | 营销对应的账户 id，TargetType 为 1 时请务必准确填写（MP 投放端的必须填写直客 id），TargetType 为 3 时可不填 |
