...
source_url: https://developers.e.qq.com/v3.0/docs/api/live_room_components/update
doc_id: tencent_ads_v3_0_docs_api_live_room_components_update
source_id: tencent_ads_v3_0_docs_api_live_room_components_update
---
# 更新直播间组件 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | live_room_components/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/live_room_components/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
