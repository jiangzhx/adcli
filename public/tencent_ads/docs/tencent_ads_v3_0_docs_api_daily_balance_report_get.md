---
title: 获取资金账户日结明细（新，包含日终结余数据） 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/daily_balance_report/get
doc_id: tencent_ads_v3_0_docs_api_daily_balance_report_get
source_id: tencent_ads_v3_0_docs_api_daily_balance_report_get
---
# 获取资金账户日结明细（新，包含日终结余数据） [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | account_management |
| --- | --- |
| 请求地址 | daily_balance_report/get |
| 请求方法 | GET |
...
```
curl -v -G 'https://api.e.qq.com/v3.0/daily_balance_report/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
