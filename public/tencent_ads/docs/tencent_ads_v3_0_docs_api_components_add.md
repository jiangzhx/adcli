...
source_url: https://developers.e.qq.com/v3.0/docs/api/components/add
doc_id: tencent_ads_v3_0_docs_api_components_add
source_id: tencent_ads_v3_0_docs_api_components_add
---
# 创建创意组件 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)
...
| component_custom_name | string | 创意组件自定义名称 字段长度最小 1 字节，长度最大 512 字节 |
...
| jump_info | struct | 落地页内容结构定义，落地页组件内容结构定义,jump_info 结构单独显示,详见 [\[落地页内容结构详细定义\]](https://developers.e.qq.com/v3.0/docs/api/components/add#jump_info_struct_href) |
| is_deleted | boolean | 是否已删除，读取接口字段有效，true：是，false：否 可选值：{ true, false } |
...
```
curl 'https://api.e.qq.com/v3.0/components/add?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
