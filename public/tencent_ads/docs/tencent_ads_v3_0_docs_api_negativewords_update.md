---
title: 更新否定词，可在营销单元、创意上更新 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/negativewords/update
doc_id: tencent_ads_v3_0_docs_api_negativewords_update
source_id: tencent_ads_v3_0_docs_api_negativewords_update
---
# 更新否定词，可在营销单元、创意上更新 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | negativewords/update |
| 请求方法 | POST |
...
```
curl 'https://api.e.qq.com/v3.0/negativewords/update?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
