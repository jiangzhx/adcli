...
source_url: https://developers.e.qq.com/v3.0/docs/api/qualification_images/get
doc_id: tencent_ads_v3_0_docs_api_qualification_images_get
source_id: tencent_ads_v3_0_docs_api_qualification_images_get
---
# [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | account_management |
| --- | --- |
| 请求地址 | qualification_images/get |
| 请求方法 | GET |
...
```
curl -v -G 'https://api.e.qq.com/v3.0/qualification_images/get?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
