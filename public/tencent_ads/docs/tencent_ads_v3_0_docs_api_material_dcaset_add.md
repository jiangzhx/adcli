---
title: 素材 DCA 集合绑定新增 全部接口
platform: tencent_ads
source_url: https://developers.e.qq.com/v3.0/docs/api/material_dcaset/add
doc_id: tencent_ads_v3_0_docs_api_material_dcaset_add
source_id: tencent_ads_v3_0_docs_api_material_dcaset_add
---
# 素材 DCA 集合绑定新增 [全部接口](https://developers.e.qq.com/v3.0/docs/apilist)

| 所属权限 | ads_management |
| --- | --- |
| 请求地址 | material_dcaset/add |
| 请求方法 | POST |
...
| image_id_list | integer[] | 图片素材 id 列表，不超过 100 个 |
| media_id_list | integer[] | 视频素材 id 列表，不超过 100 个 |
...
```
curl 'https://api.e.qq.com/v3.0/material_dcaset/add?access_token=<ACCESS_TOKEN>&timestamp=<TIMESTAMP>&nonce=<NONCE>' \
