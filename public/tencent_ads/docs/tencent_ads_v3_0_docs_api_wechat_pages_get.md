...
| owner_uid | integer | 原生页授权方 uid，[\[获取原生页授权方信息\]](https://developers.e.qq.com/docs/api/tools/wechat_pages/wechat_pages_grantinfo_get) 默认值：该字段默认值为 0, 表示拉取当前账户下的原生页 |
