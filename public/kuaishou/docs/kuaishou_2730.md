...
title: 更新商品
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2730&menuId=3463
doc_id: kuaishou_2730
source_id: kuaishou_2730
---
# 更新商品
...
| version | 0.0.5 |
| bizName | 效果广告 |
| createTime | 2025-10-20T13:30:38.360Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update |
| httpMethod | POST |
...
| dpa_product_edit_params | AdGatewayDpaProductBatchUpdateParam[] | 是 |  | 商品批量更新请求参数 |  |
| - outer_id | String | 是 |  | 广告主商品编号 |  |
...
| - main_image_url | String[] |  |  | 商品主图URL(仅支持传单个URL) |  |
...
| - sub_industry_id | String |  |  | 商品类型（保险行业必填） | 保险行业必填：人寿险-人寿险，其他险-其他险 |
...
| - wealth_product_info | WealthProductInfo |  |  | 财富行业特殊信息 |  |
...
```
curl --location --request POST 'https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update' \
...
```
{
    ...
    "message": "OK",
    "request_id": "6c875c81c01846ceb1f35a2fb8ff79d5"
}
```
