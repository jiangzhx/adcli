...
title: 智能托管更新接口
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2754&menuId=3489
doc_id: kuaishou_2754
source_id: kuaishou_2754
---
# 智能托管更新接口
...
| version | 0.0.1 |
| bizName | 效果广告 |
| createTime | 2024-07-04T12:20:02.309Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/hosting/project/update |
| httpMethod | POST |
...
| hosting_scene | Integer | 是 |  | 托管场景，0=普通场景，1=小说测书，5=最大转化 | 取值见枚举说明【hosting_scene】 |
...
| project_id | Long | 是 |  | 项目id | 注意，本属性在create时可不传或者传0，传入非0值也是不识别的；在update时，本属性必填。 |
...
| bid_type | Integer |  | 10 | 出价方式，10:普通托管、12:最大转化场景 | 10=常规推广（成本优先）、小说测书（选填）12=常规推广（跑量优先）、最大转化（必填） |
