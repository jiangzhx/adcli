...
title: 创建商品（书库-网络小说）
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3273&menuId=4048
doc_id: kuaishou_3273
source_id: kuaishou_3273
---
# 创建商品（书库-网络小说）
...
| version | 0.0.4 |
| bizName | 效果广告 |
| createTime | 2025-10-20T13:31:10.828Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/create/stackroom/fiction |
| httpMethod | POST |
...
| fiction_product_edit_params | AdGatewayDpaProductBatchCreateParamForFiction[] | 是 |  | 小说商品批量创建请求参数 |  |
...
```
curl --location 'https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/create/stackroom/fiction' \
        ...
        "product_edit_responses": [
            {
                ...
                "library_id": 2988286,
                "success": true,
                "product_id": 620427765,
                "outer_id": "8062"
            }
        ]
    },
    "message": "OK",
    "request_id": "ELqAgIDA7eGZChjFBCCJxZPniTMo-bnE5go="
}
```
