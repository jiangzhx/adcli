...
title: 魔力建站落地页组创建接口
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2649&menuId=3374
doc_id: kuaishou_2649
source_id: kuaishou_2649
---
# 魔力建站落地页组创建接口
...
| version | 0.0.1 |
| bizName | 魔力建站 |
| createTime | 2024-07-04T12:23:29.918Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/magicsite/v1/group/create |
| httpMethod | POST |
...
| group_source | Integer |  | 1 | 落地页组类型1 魔力建站2 自建站 | 不传值默认是自建站 |
| close_anchor | Integer |  | 1 | 是否关闭表单锚点 1 保持不变 2 关闭 | 针对落地页开启表单锚点的更新 |
