...
title: 广告创意数据（自定义）
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2609&menuId=3333
doc_id: kuaishou_2609
source_id: kuaishou_2609
---
# 广告创意数据（自定义）
...
| version | 0.0.9 |
| bizName | 效果广告 |
| createTime | 2026-03-12T11:26:14.157Z |
...
| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/v1/report/creative_report |
| httpMethod | POST |
...
| report_dims | String[] |  | ["adScene"] | "adScene"：按广告场景；激励视频广告/联盟/上下滑大屏广告/信息流广告/开屏广告/搜索广告/视频播放页广告/全部 "placementType"：按广告范围，快手/联盟;不传/传空/传空数组：不限 | （可选） |
...
| creative_ids | Long[] |  | [1] | 广告创意 ID 集，过滤筛选条件，单次查询数量不超过 5000 | （可选） |
| unit_ids | Long[] |  | [1] | 广告组 ID 集，过滤筛选条件，单次查询数量不超过 5000 | （可选） |
| extend_info | String[] |  | ["photo"] | 获取额外信息， "photo"获取视频信息，包含视频Id与视频md5 |  |
...
-d '
{
   	...
   	"campaign_type": 3,
   	"optimize_target": "click",
   	"page_size": 2,
   	"page": 1
}
' https://ad.e.kuaishou.com/rest/openapi/v1/report/creative_report
```
...
| data | CreativeReport |  | 1 | 数据内容 |  |
| - total_count | Long |  | 40 | 数据的总行数 |  |
| - details | Details575[] |  | [{}] | 数据明细信息 |  |
...
| - ad_photo_played_10s | Long |  | 2223 | 字段描述，需要修改 |  |
| - ad_photo_played_2s | Long |  | 7756 | 字段描述，需要修改 |  |
| - ad_photo_played_75percent | Long |  | 5732 | 字段描述，需要修改 |  |
| - approx_pay_cost | Double |  | 0.004332755632582322 | 淘系近似购买成本 |  |
| - approx_pay_count | Long |  | 6924 | 字段描述，需要修改 |  |
| - approx_pay_ratio | Double |  | 0.9487530830364483 | 淘系近似购买率 |  |
| - cancel_like | Long |  | 1326 | 字段描述，需要修改 |  |
...
| - event_ad_watch_20_times | Long |  | 4638 | 字段描述，需要修改 |  |
...
| - event_ad_watch_5_times | Long |  | 6799 | 字段描述，需要修改 |  |
...
| - event_audition | Long |  | 8614 | 字段描述，需要修改 |  |
| - event_consultation_valid_retained | Long |  | 7943 | 字段描述，需要修改 |  |
...
| - event_credit_grant_first_day_app | Long |  | 5751 | 字段描述，需要修改 |  |
...
| - event_button_click_ratio | Double |  | 0.8099479309399835 | 按钮点击成本 |  |
...
| - creative_id | Long |  | 81804206 | 广告创意 ID |  |
| - creative_name | String |  | 自定义创意_直投直播_创意1 | 广告创意名称 |  |
| - status | Long |  | 1 | 1 - 投放中；2 - 已暂停；3 - 已删除 |  |
...
| - photo_id | Long |  | 1111 | 视频ID |  |
| - photo_md5 | String |  | xxxxx | 视频MD5 |  |
| - jinjian_0d_cnt | Long |  | 11 | T0完件数 |  |
| - jinjian_3d_cnt | Long |  | 11 | T3完件数 |  |
| - jinjian_0d_cnt_cost | Double |  | 0.212 | T0完件成本 |  |
| - jinjian_3d_cnt_cost | Double |  | 0.12 | T3完件成本 |  |
| - credit_grant_0d_cnt | Long |  | 12 | T0授信数 |  |
| - credit_grant_3d_cnt | Long |  | 321 | T3授信数 |  |
| - credit_grant_0d_cnt_cost | Double |  | 0.12 | T0授信成本 |  |
| - credit_grant_3d_cnt_cost | Double |  | 0.12 | T3授信成本 |  |
| - credit_grant_0d_cnt_ratio | Double |  | 0.32 | T0完件授信率 |  |
| - credit_grant_3d_cnt_ratio | Double |  | 0.13 | T3完件授信通过率 |  |
| - key_inapp_action_0d_cnt | Long |  | 12 | T0全量授信数 |  |
| - key_inapp_action_3d_cnt | Long |  | 12 | T3全量授信数 |  |
| - key_inapp_action_0d_cnt_cost | Double |  | 0.123 | T0全量授信成本 |  |
| - key_inapp_action_3d_cnt_cost | Double |  | 0.13 | T3全量授信成本 |  |
| - key_inapp_action_0d_cnt_ratio | Double |  | 0.123 | T0全量授信通过率 |  |
| - key_inapp_action_3d_cnt_ratio | Double |  | 0.124 | T3全量授信通过率 |  |
| - draw_credit_line_0d_cnt | Long |  | 23 | T0用信数 |  |
| - draw_credit_line_0d_cnt_cost | Double |  | 0.13 | T0用信成本 |  |
| - draw_credit_line_0d_cnt_ratio | Double |  | 0.24 | T0授信用信率 |  |
        ...
        "details": [
            {
                ...
                "unit_id": 2960851,
                "unit_name": "zj-MAPI激活66818",
                "campaign_id": 2343304,
                "campaign_name": "MAPI-ZJ",
                "creative_id": 42353334,
                "creative_name": "MAPI-CT-ZJ"
            }
        ]
    }
}
