...
title: 直存试玩
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2720&menuId=3453
doc_id: kuaishou_2720
source_id: kuaishou_2720
---
# 直存试玩
...
| version | 0.0.1 |
| bizName | 效果广告 |
| createTime | 2024-07-23T02:43:23.779Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/playable/uploadAndSave |
| httpMethod | POST |
...
-L https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/playable/uploadAndSave
```
