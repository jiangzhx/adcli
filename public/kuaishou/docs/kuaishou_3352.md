...
title: 线索列表查询v3
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3352&menuId=4150
doc_id: kuaishou_3352
source_id: kuaishou_3352
---
# 线索列表查询v3
...
| version | 0.0.1 |
| bizName | CRM |
| createTime | 2026-04-02T11:10:35.136Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/crm/v3/clue/list |
| httpMethod | POST |
