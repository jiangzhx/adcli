...
title: 获取智能托管详情接口
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2757&menuId=3492
doc_id: kuaishou_2757
source_id: kuaishou_2757
---
# 获取智能托管详情接口
...
| version | 0.0.1 |
| bizName | 效果广告 |
| createTime | 2024-07-04T12:20:47.509Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/hosting/project/detail |
| httpMethod | POST |
...
| data | AdHostingProjectTypeForGateway |  |  | 托管项目详情 | 属性请参考创编的入参，含义和格式完全一样 |
...
| - schema_uri | String |  | https:// | 当campaign_type=2时，代表"开启直达链接，点击直接唤起APP"。 当campaign_type=7时，代表调起链接，需要传入http或https开头的链接，填写后优先打开调起链接，可调起应用内详情页，不填(需要加白，未在白名单则必填)则优先打开H5链接(web_uri)； |  |
...
| - ad_photo_played_t3s_url | String |  | string | 3s播放监测链接 |  |
| - intelli_budget | Boolean |  |  | 跑量优先智能预算优化开关 |  |
| - dpa_sub_type | Integer |  |  | 关联商品库类型 |  |
| - dpa_library_id | Long |  |  | 关联商品库ID |  |
| - dpa_outer_id | String |  |  | 关联商品ID |  |
