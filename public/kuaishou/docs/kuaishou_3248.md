...
title: 更新商品（音视频-漫剧）
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3248&menuId=4021
doc_id: kuaishou_3248
source_id: kuaishou_3248
---
# 更新商品（音视频-漫剧）
...
| version | 0.0.4 |
| bizName | 效果广告 |
| createTime | 2025-11-21T02:08:15.023Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update/video/cartoon/play |
| httpMethod | POST |
...
| cartoon_play_product_edit_params | AdGatewayDpaProductBatchUpdateParamForCartoonPlay[] | 是 |  | 漫剧商品批量更新请求参数 |  |
| - industry_id | Integer | 是 | 8 | 音视频-漫剧，industry_id（商品行业ID）=8 |  |
| - sub_industry_id | String | 是 | "漫剧" | 音视频-漫剧，sub_industry_id="漫剧" |  |
| - library_id | Long |  |  | 商品库ID,创建商品必须填写商品所在商品库 |  |
...
| - first_category_id | Long |  |  | 商品一级类目ID-该字段已废弃 |  |
...
| - cartoon_play_product_info | CartoonPlayProductInfoSneak |  |  | 漫剧商品批量更新请求参数 |  |
...
```
curl --location --request POST 'https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update/video/cartoon/play' \
