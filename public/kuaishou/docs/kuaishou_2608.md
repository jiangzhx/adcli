...
title: 广告组数据
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2608&menuId=3332
doc_id: kuaishou_2608
source_id: kuaishou_2608
---
# 广告组数据
...
| version | 0.1.3 |
| bizName | 效果广告 |
| createTime | 2026-05-14T02:26:45.963Z |
...
| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/v1/report/unit_report |
| httpMethod | POST |
...
| data | UnitReport |  | 1 | 数据内容 |  |
| - total_count | Long |  | 40 | 数据的总行数 |  |
| - details | Details492[] |  | [{}] | 数据明细信息 |  |
...
| - played_three_seconds | Long |  | 7849 | 播放3s |  |
| - adScene | String |  | 全部 | 投放位置 |  |
| - ad_scene | String |  | 全部 | 投放位置 |  |
| - placement_type | String |  | 全部 | 投放范围 |  |
...
| - unit_id | Long |  | 3822245 | 广告组 ID |  |
| - unit_name | String |  | zz智能定向行为数_20211127_14:46 | 广告组名称 |  |
| - status | Long |  | 1 | 1 - 投放中；2 - 已暂停；3 - 已删除 |  |
| - campaign_id | Long |  | 25132692 | 广告计划 ID |  |
| - campaign_name | String |  | 提升应用安装_20211127_13:53 | 广告计划名称 |  |
| - unit_source | Integer |  | 0 | 0:非托管 1:托管 |  |
...
| - credit_grant_3d_cnt | Long |  | 11 | T3授信数 |  |
| - credit_grant_0d_cnt_cost | Double |  | 0.11 | T0授信成本 |  |
| - credit_grant_3d_cnt_cost | Double |  | 0.13 | T3授信成本 |  |
| - credit_grant_0d_cnt_ratio | Double |  | 0.11 | T0完件授信率 |  |
| - credit_grant_3d_cnt_ratio | Double |  | 0.11 | T3完件授信通过率 |  |
| - key_inapp_action_0d_cnt | Long |  | 32 | T0全量授信数 |  |
| - key_inapp_action_3d_cnt | Long |  | 231 | T3全量授信数 |  |
| - key_inapp_action_0d_cnt_cost | Double |  | 0.23 | T0全量授信成本 |  |
| - key_inapp_action_3d_cnt_cost | Double |  | 0.13 | T3全量授信成本 |  |
| - key_inapp_action_0d_cnt_ratio | Double |  | 0.13 | T0全量授信通过率 |  |
| - key_inapp_action_3d_cnt_ratio | Double |  | 0.12 | T3全量授信通过率 |  |
| - draw_credit_line_0d_cnt | Long |  | 12 | T0用信数 |  |
| - draw_credit_line_0d_cnt_cost | Double |  | 0.321 | T0用信成本 |  |
| - draw_credit_line_0d_cnt_ratio | Double |  | 0.12 | T0授信用信率 |  |
