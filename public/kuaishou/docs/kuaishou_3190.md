...
title: 重启增量探索
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3190&menuId=3949
doc_id: kuaishou_3190
source_id: kuaishou_3190
---
# 重启增量探索
...
| version | 0.0.0 |
| bizName | 效果广告 |
| createTime | 2025-02-17T13:51:21.439Z |

## 概述

注意 1.重启对象是 ocpx_action_type X deep_conversion_type

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/account/incExplore/reboot |
| httpMethod | POST |
...
| 字段 | 类型 | 必填 | 示例 | 说明 | 备注 |
| --- | --- | --- | --- | --- | --- |
| reboot_info | GwIncExploreDetailDto[] | 是 |  | 暂停详情 |  |
...
```
{
  ...
  "data": {},
  "message": "OK",
  "request_id": "ENKAgICg1OWcChjODyCv7Pig0TIorJiS4Q0="
}
```
