...
title: 更新商品（音视频-短剧）
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3246&menuId=4018
doc_id: kuaishou_3246
source_id: kuaishou_3246
---
# 更新商品（音视频-短剧）
...
| version | 0.0.2 |
| bizName | 效果广告 |
| createTime | 2025-11-20T12:05:45.135Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update/video/short/play |
| httpMethod | POST |
...
| short_play_product_edit_params | AdGatewayDpaProductBatchUpdateParamForShortPlay[] | 是 |  | 短剧商品批量更新请求参数 |  |
...
| - first_category_id | Long |  |  | 商品一级类目ID，-该字段已废弃。详见：https://docs.qingque.cn/d/home/eZQDRKX_1XpxyUdjPnk4xpXpD?identityId=27HLQ5e0qCR |  |
| - first_category | String |  |  | 商品一级类目名称--该字段已废弃 |  |
| - second_category_id | Long |  |  | 商品二级类目ID-该字段已废弃 |  |
| - second_category | String |  |  | 商品二级类目名称-该字段已废弃 |  |
| - third_category_id | Long |  |  | 商品三级类目ID-该字段已废弃 |  |
| - third_category | String |  |  | 商品三级类目名称-该字段已废弃 |  |
| - short_play_product_info | ShortPlayProductInfoSneak |  |  | 短剧商品批量创建请求参数 |  |
...
| - sub_industry_id | String |  |  | 音视频-短剧，subIndustryId="短剧" |  |
| - industry_id | Integer |  |  | 音视频-短剧，industryId（商品行业ID）=8 |  |
...
```
curl --location --request POST 'https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/update/video/short/play' \
