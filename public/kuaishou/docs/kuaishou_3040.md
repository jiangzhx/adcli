...
title: 获取商品列表
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3040&menuId=3464
doc_id: kuaishou_3040
source_id: kuaishou_3040
---
# 获取商品列表
...
| version | 0.0.5 |
| bizName | 效果广告 |
| createTime | 2025-10-20T13:31:00.284Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/query |
| httpMethod | GET |
...
| dpa_product_query_param | AdDpaProductBatchQueryParamSneak | 是 |  | 商品批量查询请求参数 |  |
| - library_id | Long | 是 | 0 | 商品库ID |  |
| - outer_ids | String[] |  |  | 广告主商品编号 |  |
| - name | String |  |  | 商品名称 |  |
| - status | Integer |  | 0 | 商品投放状态: 0-不可投放, 1-可投放 |  |
| - check_status | Integer |  | 0 | 商品校验(接入)状态: 0-成功, 1-失败 |  |
| page_info | PageInfoSneak |  |  | 分页信息 |  |
...
```
curl --location --request GET 'https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/query' \
--header 'Access-Token: c94bb7778ad1614dd77a9c446d28c1bd' \
--header 'Content-Type: application/json' \
--data-raw '{
    "advertiser_id": 900015068,
    "dpa_product_query_param": {
...
| data | AdGatewayDpaProductBatchQueryResponse |  |  | 商品批量查询结果 |  |
...
| - price | Double |  | 0.0 | 商品现价 | 最小精度小数点后3位 |
| - value | Double |  | 0.0 | 商品原价 | 最小精度小数点后3位 |
| - saving | Double |  | 0.0 | 商品优惠价格 | 最小精度小数点后3位 |
| - discount | Double |  | 0.0 | 商品折扣 | 最小精度小数点后3位 |
| - age_v2 | String[] |  |  | 商品定向年龄: 18-23, 24-30, 31-40, 41-49, 50+ | 18-23, 24-30, 31-40, 41-49, 50+ |
| - gender | Integer |  | 0 | 商品定向性别: 0-不限, 1-男, 2-女 | 0-不限, 1-男, 2-女 |
...
| - slogan | String |  |  | 商品广告语 |  |
| - industry_id | Integer |  | 0 | 商品行业ID | 1-电商, 3-保险, 5-书库, 8-音视频, 9-医药, 10-招聘, 11-区域服务, 12-通信 |
| - sub_industry_id | String |  |  | 商品二级行业ID | 书库: 1-网络小说, 2-漫画, 3-有声读物, 4-网赚; 音视频: 电影, 动漫, 纪录片, 综艺, 电视剧, 短剧, 音乐, 直播, 网赚, 其他 |
| - industry_name | String |  |  | 商品行业名称 | 1-电商, 3-保险, 5-书库, 8-音视频, 9-医药, 10-招聘, 11-区域服务, 12-通信 |
| - sub_industry_name | String |  |  | 商品二级行业名称 | 小说: 1-网络小说, 2-漫画, 3-有声读物, 4-网赚; 音视频: 电影, 动漫, 纪录片, 综艺, 电视剧, 短剧, 音乐, 直播, 网赚, 其他 |
| - product_id | Long |  | 0 | 商品ID | 快手生成商品唯一标识 |
...
| - tel | String |  |  | 联系电话 |  |
| - nationality | String |  |  | 所在国家 |  |
| - province | String |  |  | 所在省份 | 详见接口https://ad.e.kuaishou.com/rest/openapi/v1/region/list |
| - city | String |  |  | 所在城市 | 详见接口https://ad.e.kuaishou.com/rest/openapi/v1/region/list |
| - district | String |  |  | 所在地区 |  |
| - region | String[] |  |  | 所在商圈区域 |  |
...
| - new_insurer_time | String |  |  | 保障期限：（1天，1月，2年） |  |
| - insurer | String |  |  | 保险公司 |  |
| - insurer_type | String |  |  | 承保公司性质 |  |
| - spokesperson | String |  |  | 投放保险公司代言人 |  |
| - insured_min_age | Integer |  |  | 投保最小年龄 |  |
| - insured_max_age | Integer |  |  | 投保最大年龄 |  |
| - payout_amount | Double |  |  | 保险赔付金额 |  |
| - staging | Integer |  |  | 是否分期 1 - 分期 2- 不分期 |  |
...
| - province | String |  |  | 所在省份 |  |
| - city | String |  |  | 所在城市 | 详见接口https://ad.e.kuaishou.com/rest/openapi/v1/region/list |
| - district | String |  |  | 所在地区 | 详见接口https://ad.e.kuaishou.com/rest/openapi/v1/region/list |
| - product_view_count | Long |  | 0 | 商品详情页打开次数 |  |
| - favorite_count | Long |  | 0 | 收藏用户数 |  |
| - favourable_comment_rate | Long |  | 0 | 好评率 |  |
| - mark | Double |  | 0.0 | 评分 |  |
...
```
{
    ...
    "message": "OK",
    "request_id": "bcdfe3d24dbe4342ab2f9ef46ad97bb1"
}
```
