...
title: 智能托管报表接口
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=2759&menuId=3495
doc_id: kuaishou_2759
source_id: kuaishou_2759
---
# 智能托管报表接口
...
| version | 0.0.1 |
| bizName | 效果广告 |
| createTime | 2024-07-04T12:21:16.249Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/hosting/project/list |
| httpMethod | POST |
...
| start_time | Long | 是 |  | 开始时间 | 13位毫秒时间戳 只支持最近查询七天 |
| end_time | Long | 是 |  | 结束时间 | 13位毫秒时间戳 只支持最近查询七天 |
...
| data | AdHostingProjectReportListViewForGateway |  |  | 数据 |  |
| - projects | AdHostingProjectReportViewForGateway[] |  |  | 每个项目包括物料和效果的数据列表 |  |
...
| - name | String |  |  | 托管单元名称 |  |
| - hosting_scene | Integer |  |  | 托管场景 |  |
| - campaign_type | Integer |  |  | 计划类型 |  |
| - campaign_id | Long |  |  | 计划id |  |
| - put_status | Integer |  |  | 投放状态 |  |
| - day_budget | Long |  |  | 投放预算 |  |
| - deep_conversion_type | Integer |  |  | 深度转化类型 |  |
| - deep_conversion_bid | Long |  |  | 深度类型出价 |  |
| - ocpx_action_type | Integer |  |  | 浅层优化目标 |  |
| - cpa_bid | Long |  |  | 浅层优化目标出价 |  |
| - roi_ratio | Double |  |  | ROI系数 |  |
| - hit_line_status | Integer |  |  | hitLineStatus |  |
| - material_status | Long |  |  | materialStatus |  |
| - charge_last_change_time | Long |  |  | chargeLastChangeTime |  |
| - project_charge_status | Integer |  |  | projectChargeStatus |  |
