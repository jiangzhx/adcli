...
title: 创建商品（医疗库）
platform: kuaishou
source_url: https://developers.e.kuaishou.com/docs?docType=DSP&documentId=3283&menuId=4060
doc_id: kuaishou_3283
source_id: kuaishou_3283
---
# 创建商品（医疗库）
...
| version | 0.0.2 |
| bizName | 效果广告 |
| createTime | 2025-09-04T11:07:03.913Z |

## 接口信息

| 字段 | 值 |
| --- | --- |
| targetPath | https://ad.e.kuaishou.com/rest/openapi/gw/dsp/v1/dpa/product/batch/create/pharmaceutical |
| httpMethod | POST |
...
| pharmaceutical_product_edit_params | AdGatewayDpaProductCreateParamForPharmaceutical[] | 是 |  | 医疗库商品批量创建请求参数 |  |
