...
export class PromotionListV30Api {
  ...
  async openApiV30PromotionListGet(advertiserId: number, filtering: PromotionListV30Filtering, fields: string[], includingMaterialAtrributes: PromotionListV30IncludingMaterialAtrributes, page: number, pageSize: number, cursor: number, count: number): Promise<PromotionListV30Response> {
  ...
  async openApiV30PromotionListGetWithHttpInfo(advertiserId: number, filtering: PromotionListV30Filtering, fields: string[], includingMaterialAtrributes: PromotionListV30IncludingMaterialAtrributes, page: number, pageSize: number, cursor: number, count: number): Promise<ApiResponse<PromotionListV30Response>> {
