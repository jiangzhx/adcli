...
export class QianchuanReportTodayLiveGetV10Api {
  ...
  async openApiV10QianchuanReportTodayLiveGetGet(advertiserId: number, awemeId: number, startTime: string, endTime: string, fields: string[], statsAuthority: QianchuanReportTodayLiveGetV10StatsAuthority): Promise<QianchuanReportTodayLiveGetV10Response> {
    const response = await this.openApiV10QianchuanReportTodayLiveGetGetWithHttpInfo(advertiserId, awemeId, startTime, endTime, fields, statsAuthority);
    return response.data;
  }

  async openApiV10QianchuanReportTodayLiveGetGetWithHttpInfo(advertiserId: number, awemeId: number, startTime: string, endTime: string, fields: string[], statsAuthority: QianchuanReportTodayLiveGetV10StatsAuthority): Promise<ApiResponse<QianchuanReportTodayLiveGetV10Response>> {
