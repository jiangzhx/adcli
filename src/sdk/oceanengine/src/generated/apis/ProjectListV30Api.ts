...
export class ProjectListV30Api {
  ...
  async openApiV30ProjectListGet(advertiserId: number, fields: string[], filtering: ProjectListV30Filtering, page: number, pageSize: number): Promise<ProjectListV30Response> {
    const response = await this.openApiV30ProjectListGetWithHttpInfo(advertiserId, fields, filtering, page, pageSize);
    return response.data;
  }

  async openApiV30ProjectListGetWithHttpInfo(advertiserId: number, fields: string[], filtering: ProjectListV30Filtering, page: number, pageSize: number): Promise<ApiResponse<ProjectListV30Response>> {
