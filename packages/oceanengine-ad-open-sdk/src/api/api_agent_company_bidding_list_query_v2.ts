// Generated from oceanengine/ad_open_sdk_go api/api_agent_company_bidding_list_query_v2.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { AgentCompanyBiddingListQueryV2Filtering, AgentCompanyBiddingListQueryV2Response } from "../models/index";


export interface AgentCompanyBiddingListQueryV2ApiOpenApi2AgentCompanyBiddingListQueryGetRequest {
...
export class AgentCompanyBiddingListQueryV2Api {
  ...
  async openApi2AgentCompanyBiddingListQueryGet(request: AgentCompanyBiddingListQueryV2ApiOpenApi2AgentCompanyBiddingListQueryGetRequest): Promise<AgentCompanyBiddingListQueryV2Response> {
    const response = await this.openApi2AgentCompanyBiddingListQueryGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2AgentCompanyBiddingListQueryGetWithHttpInfo(request: AgentCompanyBiddingListQueryV2ApiOpenApi2AgentCompanyBiddingListQueryGetRequest): Promise<ApiResponse<AgentCompanyBiddingListQueryV2Response>> {
