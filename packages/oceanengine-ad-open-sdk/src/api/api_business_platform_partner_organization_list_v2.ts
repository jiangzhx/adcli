// Generated from oceanengine/ad_open_sdk_go api/api_business_platform_partner_organization_list_v2.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { BusinessPlatformPartnerOrganizationListV2Filtering, BusinessPlatformPartnerOrganizationListV2Response } from "../models/index";


export interface BusinessPlatformPartnerOrganizationListV2ApiOpenApi2BusinessPlatformPartnerOrganizationListGetRequest {
...
export class BusinessPlatformPartnerOrganizationListV2Api {
  ...
  async openApi2BusinessPlatformPartnerOrganizationListGet(request: BusinessPlatformPartnerOrganizationListV2ApiOpenApi2BusinessPlatformPartnerOrganizationListGetRequest): Promise<BusinessPlatformPartnerOrganizationListV2Response> {
