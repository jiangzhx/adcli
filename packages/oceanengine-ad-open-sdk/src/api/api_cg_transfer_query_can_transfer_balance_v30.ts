...
export interface CgTransferQueryCanTransferBalanceV30ApiOpenApiV30CgTransferQueryCanTransferBalanceGetRequest {
  bizRequestNo: string;
...
export class CgTransferQueryCanTransferBalanceV30Api {
  ...
  async openApiV30CgTransferQueryCanTransferBalanceGet(request: CgTransferQueryCanTransferBalanceV30ApiOpenApiV30CgTransferQueryCanTransferBalanceGetRequest): Promise<CgTransferQueryCanTransferBalanceV30Response> {
