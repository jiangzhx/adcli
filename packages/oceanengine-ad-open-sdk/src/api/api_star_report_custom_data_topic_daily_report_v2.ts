// Generated from oceanengine/ad_open_sdk_go api/api_star_report_custom_data_topic_daily_report_v2.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { StarReportCustomDataTopicDailyReportV2Response, StarReportCustomDataTopicDailyReportV2Topics } from "../models/index";


export interface StarReportCustomDataTopicDailyReportV2ApiOpenApi2StarReportCustomDataTopicDailyReportGetRequest {
...
export class StarReportCustomDataTopicDailyReportV2Api {
  ...
  async openApi2StarReportCustomDataTopicDailyReportGet(request: StarReportCustomDataTopicDailyReportV2ApiOpenApi2StarReportCustomDataTopicDailyReportGetRequest): Promise<StarReportCustomDataTopicDailyReportV2Response> {
