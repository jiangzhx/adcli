...
export interface ToolsBidsSuggestV30ApiOpenApiV30ToolsBidsSuggestGetRequest {
...
export class ToolsBidsSuggestV30Api {
  ...
  async openApiV30ToolsBidsSuggestGet(request: ToolsBidsSuggestV30ApiOpenApiV30ToolsBidsSuggestGetRequest): Promise<ToolsBidsSuggestV30Response> {
