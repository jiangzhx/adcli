...
export interface ReportStardeliveryTaskVideoDataGetV30ApiOpenApiV30ReportStardeliveryTaskVideoDataGetGetRequest {
...
export class ReportStardeliveryTaskVideoDataGetV30Api {
  ...
  async openApiV30ReportStardeliveryTaskVideoDataGetGet(request: ReportStardeliveryTaskVideoDataGetV30ApiOpenApiV30ReportStardeliveryTaskVideoDataGetGetRequest): Promise<ReportStardeliveryTaskVideoDataGetV30Response> {
    const response = await this.openApiV30ReportStardeliveryTaskVideoDataGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportStardeliveryTaskVideoDataGetGetWithHttpInfo(request: ReportStardeliveryTaskVideoDataGetV30ApiOpenApiV30ReportStardeliveryTaskVideoDataGetGetRequest): Promise<ApiResponse<ReportStardeliveryTaskVideoDataGetV30Response>> {
