// Generated from oceanengine/ad_open_sdk_go api/api_report_stardelivery_task_data_get_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { ReportStardeliveryTaskDataGetV30Filtering, ReportStardeliveryTaskDataGetV30OrderType, ReportStardeliveryTaskDataGetV30Response } from "../models/index";


export interface ReportStardeliveryTaskDataGetV30ApiOpenApiV30ReportStardeliveryTaskDataGetGetRequest {
...
export class ReportStardeliveryTaskDataGetV30Api {
  ...
  async openApiV30ReportStardeliveryTaskDataGetGet(request: ReportStardeliveryTaskDataGetV30ApiOpenApiV30ReportStardeliveryTaskDataGetGetRequest): Promise<ReportStardeliveryTaskDataGetV30Response> {
    const response = await this.openApiV30ReportStardeliveryTaskDataGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportStardeliveryTaskDataGetGetWithHttpInfo(request: ReportStardeliveryTaskDataGetV30ApiOpenApiV30ReportStardeliveryTaskDataGetGetRequest): Promise<ApiResponse<ReportStardeliveryTaskDataGetV30Response>> {
