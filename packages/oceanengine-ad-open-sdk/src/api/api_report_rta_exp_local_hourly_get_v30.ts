// Generated from oceanengine/ad_open_sdk_go api/api_report_rta_exp_local_hourly_get_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { ReportRtaExpLocalHourlyGetV30Response } from "../models/index";


export interface ReportRtaExpLocalHourlyGetV30ApiOpenApiV30ReportRtaExpLocalHourlyGetGetRequest {
  rtaId: number | string;
...
export class ReportRtaExpLocalHourlyGetV30Api {
  ...
  async openApiV30ReportRtaExpLocalHourlyGetGet(request: ReportRtaExpLocalHourlyGetV30ApiOpenApiV30ReportRtaExpLocalHourlyGetGetRequest): Promise<ReportRtaExpLocalHourlyGetV30Response> {
