// Generated from oceanengine/ad_open_sdk_go api/api_dpa_category_get_v2.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { DpaCategoryGetV2Response } from "../models/index";


export interface DpaCategoryGetV2ApiOpenApi2DpaCategoryGetGetRequest {
...
export class DpaCategoryGetV2Api {
  ...
  async openApi2DpaCategoryGetGet(request: DpaCategoryGetV2ApiOpenApi2DpaCategoryGetGetRequest): Promise<DpaCategoryGetV2Response> {
