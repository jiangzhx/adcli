// Generated from oceanengine/ad_open_sdk_go api/api_wallet_remittance_code_list_get_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { WalletRemittanceCodeListGetV30ChargeTargetType, WalletRemittanceCodeListGetV30Response } from "../models/index";


export interface WalletRemittanceCodeListGetV30ApiOpenApiV30WalletRemittanceCodeListGetGetRequest {
...
export class WalletRemittanceCodeListGetV30Api {
  ...
  async openApiV30WalletRemittanceCodeListGetGet(request: WalletRemittanceCodeListGetV30ApiOpenApiV30WalletRemittanceCodeListGetGetRequest): Promise<WalletRemittanceCodeListGetV30Response> {
