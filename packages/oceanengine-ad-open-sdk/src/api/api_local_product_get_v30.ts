// Generated from oceanengine/ad_open_sdk_go api/api_local_product_get_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { LocalProductGetV30Filtering, LocalProductGetV30LocalDeliveryScene, LocalProductGetV30Response } from "../models/index";


export interface LocalProductGetV30ApiOpenApiV30LocalProductGetGetRequest {
...
export class LocalProductGetV30Api {
  ...
  async openApiV30LocalProductGetGet(request: LocalProductGetV30ApiOpenApiV30LocalProductGetGetRequest): Promise<LocalProductGetV30Response> {
