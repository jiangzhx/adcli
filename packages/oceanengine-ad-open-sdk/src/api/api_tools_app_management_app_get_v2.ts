// Generated from oceanengine/ad_open_sdk_go api/api_tools_app_management_app_get_v2.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { ToolsAppManagementAppGetV2AccountAssetQueryScope, ToolsAppManagementAppGetV2CreateTime, ToolsAppManagementAppGetV2PublishTime, ToolsAppManagementAppGetV2Response, ToolsAppManagementAppGetV2SearchType, ToolsAppManagementAppGetV2Status } from "../models/index";


export interface ToolsAppManagementAppGetV2ApiOpenApi2ToolsAppManagementAppGetGetRequest {
...
export class ToolsAppManagementAppGetV2Api {
  ...
  async openApi2ToolsAppManagementAppGetGet(request: ToolsAppManagementAppGetV2ApiOpenApi2ToolsAppManagementAppGetGetRequest): Promise<ToolsAppManagementAppGetV2Response> {
