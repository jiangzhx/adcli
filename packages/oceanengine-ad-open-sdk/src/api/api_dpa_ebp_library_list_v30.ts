// Generated from oceanengine/ad_open_sdk_go api/api_dpa_ebp_library_list_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { DpaEbpLibraryListV30AccountType, DpaEbpLibraryListV30AssetQueryScope, DpaEbpLibraryListV30Response } from "../models/index";


export interface DpaEbpLibraryListV30ApiOpenApiV30DpaEbpLibraryListGetRequest {
...
export class DpaEbpLibraryListV30Api {
  ...
  async openApiV30DpaEbpLibraryListGet(request: DpaEbpLibraryListV30ApiOpenApiV30DpaEbpLibraryListGetRequest): Promise<DpaEbpLibraryListV30Response> {
