// Generated from oceanengine/ad_open_sdk_go api/api_cg_transfer_transfer_detail_get_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { CgTransferTransferDetailGetV30Platform, CgTransferTransferDetailGetV30Response } from "../models/index";


export interface CgTransferTransferDetailGetV30ApiOpenApiV30CgTransferTransferDetailGetGetRequest {
...
export class CgTransferTransferDetailGetV30Api {
  ...
  async openApiV30CgTransferTransferDetailGetGet(request: CgTransferTransferDetailGetV30ApiOpenApiV30CgTransferTransferDetailGetGetRequest): Promise<CgTransferTransferDetailGetV30Response> {
