// Generated from oceanengine/ad_open_sdk_go api/api_qianchuan_uni_aweme_suggest_budget_v10.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { QianchuanUniAwemeSuggestBudgetV10MarketingGoal, QianchuanUniAwemeSuggestBudgetV10Response } from "../models/index";


export interface QianchuanUniAwemeSuggestBudgetV10ApiOpenApiV10QianchuanUniAwemeSuggestBudgetGetRequest {
...
export class QianchuanUniAwemeSuggestBudgetV10Api {
  ...
  async openApiV10QianchuanUniAwemeSuggestBudgetGet(request: QianchuanUniAwemeSuggestBudgetV10ApiOpenApiV10QianchuanUniAwemeSuggestBudgetGetRequest): Promise<QianchuanUniAwemeSuggestBudgetV10Response> {
