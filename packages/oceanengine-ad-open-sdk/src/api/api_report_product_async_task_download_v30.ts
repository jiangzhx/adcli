// Generated from oceanengine/ad_open_sdk_go api/api_report_product_async_task_download_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";


export interface ReportProductAsyncTaskDownloadV30ApiOpenApiV30ReportProductAsyncTaskDownloadGetRequest {
...
export class ReportProductAsyncTaskDownloadV30Api {
  ...
  async openApiV30ReportProductAsyncTaskDownloadGet(request: ReportProductAsyncTaskDownloadV30ApiOpenApiV30ReportProductAsyncTaskDownloadGetRequest): Promise<ArrayBuffer> {
