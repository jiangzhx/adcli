...
export interface ReportCampaignGetV2ApiOpenApi2ReportCampaignGetGetRequest {
...
export class ReportCampaignGetV2Api {
  ...
  async openApi2ReportCampaignGetGet(request: ReportCampaignGetV2ApiOpenApi2ReportCampaignGetGetRequest): Promise<ReportCampaignGetV2Response> {
    const response = await this.openApi2ReportCampaignGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2ReportCampaignGetGetWithHttpInfo(request: ReportCampaignGetV2ApiOpenApi2ReportCampaignGetGetRequest): Promise<ApiResponse<ReportCampaignGetV2Response>> {
