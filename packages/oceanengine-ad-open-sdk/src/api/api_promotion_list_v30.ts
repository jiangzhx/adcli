// Generated from oceanengine/ad_open_sdk_go api/api_promotion_list_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { PromotionListV30Filtering, PromotionListV30IncludingMaterialAtrributes, PromotionListV30Response } from "../models/index";


export interface PromotionListV30ApiOpenApiV30PromotionListGetRequest {
...
export class PromotionListV30Api {
  ...
  async openApiV30PromotionListGet(request: PromotionListV30ApiOpenApiV30PromotionListGetRequest): Promise<PromotionListV30Response> {
    const response = await this.openApiV30PromotionListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30PromotionListGetWithHttpInfo(request: PromotionListV30ApiOpenApiV30PromotionListGetRequest): Promise<ApiResponse<PromotionListV30Response>> {
