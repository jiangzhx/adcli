// Generated from oceanengine/ad_open_sdk_go api/api_brand_tool_creative_preview_v30.go
// Do not edit manually.

import { ApiClient, ApiException, type ApiResponse } from "./client";
import type { BrandToolCreativePreviewV30Response } from "../models/index";


export interface BrandToolCreativePreviewV30ApiOpenApiV30BrandToolCreativePreviewGetRequest {
...
export class BrandToolCreativePreviewV30Api {
  ...
  async openApiV30BrandToolCreativePreviewGet(request: BrandToolCreativePreviewV30ApiOpenApiV30BrandToolCreativePreviewGetRequest): Promise<BrandToolCreativePreviewV30Response> {
