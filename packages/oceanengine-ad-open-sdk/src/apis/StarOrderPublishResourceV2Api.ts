...
export class StarOrderPublishResourceV2Api {
  ...
  async openApi2StarOrderPublishResourcePost(request: StarOrderPublishResourceV2Request): Promise<StarOrderPublishResourceV2Response> {
    const response = await this.openApi2StarOrderPublishResourcePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarOrderPublishResourcePostWithHttpInfo(request: StarOrderPublishResourceV2Request): Promise<ApiResponse<StarOrderPublishResourceV2Response>> {
