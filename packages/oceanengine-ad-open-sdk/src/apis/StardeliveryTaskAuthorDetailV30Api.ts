...
export class StardeliveryTaskAuthorDetailV30Api {
  ...
  async openApiV30StardeliveryTaskAuthorDetailGet(request: OpenApiV30StardeliveryTaskAuthorDetailGetRequest): Promise<StardeliveryTaskAuthorDetailV30Response> {
    const response = await this.openApiV30StardeliveryTaskAuthorDetailGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30StardeliveryTaskAuthorDetailGetWithHttpInfo(request: OpenApiV30StardeliveryTaskAuthorDetailGetRequest): Promise<ApiResponse<StardeliveryTaskAuthorDetailV30Response>> {
