...
export class CgTransferWalletTransferCreateV30Api {
  ...
  async openApiV30CgTransferWalletTransferCreatePost(request: CgTransferWalletTransferCreateV30Request): Promise<CgTransferWalletTransferCreateV30Response> {
    const response = await this.openApiV30CgTransferWalletTransferCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30CgTransferWalletTransferCreatePostWithHttpInfo(request: CgTransferWalletTransferCreateV30Request): Promise<ApiResponse<CgTransferWalletTransferCreateV30Response>> {
