...
export class ToolsPrivativeWordAdUpdateV2Api {
  ...
  async openApi2ToolsPrivativeWordAdUpdatePost(request: ToolsPrivativeWordAdUpdateV2Request): Promise<ToolsPrivativeWordAdUpdateV2Response> {
    const response = await this.openApi2ToolsPrivativeWordAdUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsPrivativeWordAdUpdatePostWithHttpInfo(request: ToolsPrivativeWordAdUpdateV2Request): Promise<ApiResponse<ToolsPrivativeWordAdUpdateV2Response>> {
