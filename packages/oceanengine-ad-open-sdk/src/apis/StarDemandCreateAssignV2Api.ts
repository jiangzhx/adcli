...
export class StarDemandCreateAssignV2Api {
  ...
  async openApi2StarDemandCreateAssignPost(request: StarDemandCreateAssignV2Request): Promise<StarDemandCreateAssignV2Response> {
    const response = await this.openApi2StarDemandCreateAssignPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarDemandCreateAssignPostWithHttpInfo(request: StarDemandCreateAssignV2Request): Promise<ApiResponse<StarDemandCreateAssignV2Response>> {
