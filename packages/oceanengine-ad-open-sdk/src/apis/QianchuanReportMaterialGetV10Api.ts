...
export class QianchuanReportMaterialGetV10Api {
  ...
  async openApiV10QianchuanReportMaterialGetGet(request: OpenApiV10QianchuanReportMaterialGetGetRequest): Promise<QianchuanReportMaterialGetV10Response> {
    const response = await this.openApiV10QianchuanReportMaterialGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanReportMaterialGetGetWithHttpInfo(request: OpenApiV10QianchuanReportMaterialGetGetRequest): Promise<ApiResponse<QianchuanReportMaterialGetV10Response>> {
