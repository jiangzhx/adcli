...
export class RecommendVideoListV30Api {
  ...
  async openApiV30RecommendVideoListPost(request: RecommendVideoListV30Request): Promise<RecommendVideoListV30Response> {
    const response = await this.openApiV30RecommendVideoListPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30RecommendVideoListPostWithHttpInfo(request: RecommendVideoListV30Request): Promise<ApiResponse<RecommendVideoListV30Response>> {
