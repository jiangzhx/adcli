...
export class QianchuanReportUniPromotionDimensionDataRoomGetV10Api {
  ...
  async openApiV10QianchuanReportUniPromotionDimensionDataRoomGetGet(request: OpenApiV10QianchuanReportUniPromotionDimensionDataRoomGetGetRequest): Promise<QianchuanReportUniPromotionDimensionDataRoomGetV10Response> {
    const response = await this.openApiV10QianchuanReportUniPromotionDimensionDataRoomGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanReportUniPromotionDimensionDataRoomGetGetWithHttpInfo(request: OpenApiV10QianchuanReportUniPromotionDimensionDataRoomGetGetRequest): Promise<ApiResponse<QianchuanReportUniPromotionDimensionDataRoomGetV10Response>> {
