...
export class QianchuanCampaignCreateV10Api {
  ...
  async openApiV10QianchuanCampaignCreatePost(request: QianchuanCampaignCreateV10Request): Promise<QianchuanCampaignCreateV10Response> {
    const response = await this.openApiV10QianchuanCampaignCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanCampaignCreatePostWithHttpInfo(request: QianchuanCampaignCreateV10Request): Promise<ApiResponse<QianchuanCampaignCreateV10Response>> {
