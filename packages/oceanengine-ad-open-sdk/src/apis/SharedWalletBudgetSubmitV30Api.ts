...
export class SharedWalletBudgetSubmitV30Api {
  ...
  async openApiV30SharedWalletBudgetSubmitPost(request: SharedWalletBudgetSubmitV30Request): Promise<SharedWalletBudgetSubmitV30Response> {
    const response = await this.openApiV30SharedWalletBudgetSubmitPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30SharedWalletBudgetSubmitPostWithHttpInfo(request: SharedWalletBudgetSubmitV30Request): Promise<ApiResponse<SharedWalletBudgetSubmitV30Response>> {
