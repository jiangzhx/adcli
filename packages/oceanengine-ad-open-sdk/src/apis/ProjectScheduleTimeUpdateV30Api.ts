...
export class ProjectScheduleTimeUpdateV30Api {
  ...
  async openApiV30ProjectScheduleTimeUpdatePost(request: ProjectScheduleTimeUpdateV30Request): Promise<ProjectScheduleTimeUpdateV30Response> {
    const response = await this.openApiV30ProjectScheduleTimeUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ProjectScheduleTimeUpdatePostWithHttpInfo(request: ProjectScheduleTimeUpdateV30Request): Promise<ApiResponse<ProjectScheduleTimeUpdateV30Response>> {
