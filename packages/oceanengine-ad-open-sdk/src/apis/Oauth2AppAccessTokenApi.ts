...
export class Oauth2AppAccessTokenApi {
  ...
  async openApiOauth2AppAccessTokenPost(request: Oauth2AppAccessTokenRequest): Promise<Oauth2AppAccessTokenResponse> {
    const response = await this.openApiOauth2AppAccessTokenPostWithHttpInfo(request);
    return response.data;
  }

  async openApiOauth2AppAccessTokenPostWithHttpInfo(request: Oauth2AppAccessTokenRequest): Promise<ApiResponse<Oauth2AppAccessTokenResponse>> {
