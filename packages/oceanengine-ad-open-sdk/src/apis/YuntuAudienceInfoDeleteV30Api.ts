...
export class YuntuAudienceInfoDeleteV30Api {
  ...
  async openApiV30YuntuAudienceInfoDeletePost(request: YuntuAudienceInfoDeleteV30Request): Promise<YuntuAudienceInfoDeleteV30Response> {
    const response = await this.openApiV30YuntuAudienceInfoDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30YuntuAudienceInfoDeletePostWithHttpInfo(request: YuntuAudienceInfoDeleteV30Request): Promise<ApiResponse<YuntuAudienceInfoDeleteV30Response>> {
