...
export class ToolsAppManagementExtendPackageUpdateV2V2Api {
  ...
  async openApi2ToolsAppManagementExtendPackageUpdateV2Post(request: ToolsAppManagementExtendPackageUpdateV2V2Request): Promise<ToolsAppManagementExtendPackageUpdateV2V2Response> {
    const response = await this.openApi2ToolsAppManagementExtendPackageUpdateV2PostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAppManagementExtendPackageUpdateV2PostWithHttpInfo(request: ToolsAppManagementExtendPackageUpdateV2V2Request): Promise<ApiResponse<ToolsAppManagementExtendPackageUpdateV2V2Response>> {
