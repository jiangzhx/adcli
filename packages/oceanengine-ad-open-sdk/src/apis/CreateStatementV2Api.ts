...
export class CreateStatementV2Api {
  ...
  async openApi2CreateStatementPost(request: CreateStatementV2Request): Promise<CreateStatementV2Response> {
    const response = await this.openApi2CreateStatementPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2CreateStatementPostWithHttpInfo(request: CreateStatementV2Request): Promise<ApiResponse<CreateStatementV2Response>> {
