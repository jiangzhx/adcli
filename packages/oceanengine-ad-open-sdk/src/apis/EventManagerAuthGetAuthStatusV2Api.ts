...
export class EventManagerAuthGetAuthStatusV2Api {
  ...
  async openApi2EventManagerAuthGetAuthStatusGet(advertiserId: number): Promise<EventManagerAuthGetAuthStatusV2Response> {
    const response = await this.openApi2EventManagerAuthGetAuthStatusGetWithHttpInfo(advertiserId);
    return response.data;
  }

  async openApi2EventManagerAuthGetAuthStatusGetWithHttpInfo(advertiserId: number): Promise<ApiResponse<EventManagerAuthGetAuthStatusV2Response>> {
