...
export class StarComponentCreateCommonComponentV2Api {
  ...
  async openApi2StarComponentCreateCommonComponentPost(request: StarComponentCreateCommonComponentV2Request): Promise<StarComponentCreateCommonComponentV2Response> {
    const response = await this.openApi2StarComponentCreateCommonComponentPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarComponentCreateCommonComponentPostWithHttpInfo(request: StarComponentCreateCommonComponentV2Request): Promise<ApiResponse<StarComponentCreateCommonComponentV2Response>> {
