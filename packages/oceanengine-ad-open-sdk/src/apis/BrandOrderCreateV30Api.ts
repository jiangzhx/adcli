...
export class BrandOrderCreateV30Api {
  ...
  async openApiV30BrandOrderCreatePost(request: BrandOrderCreateV30Request): Promise<BrandOrderCreateV30Response> {
    const response = await this.openApiV30BrandOrderCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30BrandOrderCreatePostWithHttpInfo(request: BrandOrderCreateV30Request): Promise<ApiResponse<BrandOrderCreateV30Response>> {
