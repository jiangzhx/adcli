...
export class StdProjectUpdateV30Api {
  ...
  async openApiV30StdProjectUpdatePost(request: StdProjectUpdateV30Request): Promise<StdProjectUpdateV30Response> {
    const response = await this.openApiV30StdProjectUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30StdProjectUpdatePostWithHttpInfo(request: StdProjectUpdateV30Request): Promise<ApiResponse<StdProjectUpdateV30Response>> {
