...
export interface OpenApiV30ReportBrandDataGetRequest {
...
export class ReportBrandDataV30Api {
  ...
  async openApiV30ReportBrandDataGet(request: OpenApiV30ReportBrandDataGetRequest): Promise<ReportBrandDataV30Response> {
    const response = await this.openApiV30ReportBrandDataGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportBrandDataGetWithHttpInfo(request: OpenApiV30ReportBrandDataGetRequest): Promise<ApiResponse<ReportBrandDataV30Response>> {
