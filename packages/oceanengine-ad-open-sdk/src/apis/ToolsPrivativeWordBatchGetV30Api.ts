...
export interface OpenApiV30ToolsPrivativeWordBatchGetPostRequest {
...
export class ToolsPrivativeWordBatchGetV30Api {
  ...
  async openApiV30ToolsPrivativeWordBatchGetPost(request: OpenApiV30ToolsPrivativeWordBatchGetPostRequest): Promise<ToolsPrivativeWordBatchGetV30Response> {
    const response = await this.openApiV30ToolsPrivativeWordBatchGetPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsPrivativeWordBatchGetPostWithHttpInfo(request: OpenApiV30ToolsPrivativeWordBatchGetPostRequest): Promise<ApiResponse<ToolsPrivativeWordBatchGetV30Response>> {
