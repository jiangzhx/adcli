...
export class QianchuanReportTodayLiveRoomDataGetV10Api {
  ...
  async openApiV10QianchuanReportTodayLiveRoomDataGetGet(request: OpenApiV10QianchuanReportTodayLiveRoomDataGetGetRequest): Promise<QianchuanReportTodayLiveRoomDataGetV10Response> {
    const response = await this.openApiV10QianchuanReportTodayLiveRoomDataGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanReportTodayLiveRoomDataGetGetWithHttpInfo(request: OpenApiV10QianchuanReportTodayLiveRoomDataGetGetRequest): Promise<ApiResponse<QianchuanReportTodayLiveRoomDataGetV10Response>> {
