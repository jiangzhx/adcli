...
export class ClueCouponUpdateV2Api {
  ...
  async openApi2ClueCouponUpdatePost(request: ClueCouponUpdateV2Request): Promise<ClueCouponUpdateV2Response> {
    const response = await this.openApi2ClueCouponUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ClueCouponUpdatePostWithHttpInfo(request: ClueCouponUpdateV2Request): Promise<ApiResponse<ClueCouponUpdateV2Response>> {
