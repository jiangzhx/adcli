...
export interface OpenApi2ToolsEstimateAudienceGetRequest {
...
export class ToolsEstimateAudienceV2Api {
  ...
  async openApi2ToolsEstimateAudienceGet(request: OpenApi2ToolsEstimateAudienceGetRequest): Promise<ToolsEstimateAudienceV2Response> {
    const response = await this.openApi2ToolsEstimateAudienceGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsEstimateAudienceGetWithHttpInfo(request: OpenApi2ToolsEstimateAudienceGetRequest): Promise<ApiResponse<ToolsEstimateAudienceV2Response>> {
