...
export class StarAttributeUserEventFeedbackV2Api {
  ...
  async openApi2StarAttributeUserEventFeedbackPost(request: StarAttributeUserEventFeedbackV2Request): Promise<StarAttributeUserEventFeedbackV2Response> {
    const response = await this.openApi2StarAttributeUserEventFeedbackPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarAttributeUserEventFeedbackPostWithHttpInfo(request: StarAttributeUserEventFeedbackV2Request): Promise<ApiResponse<StarAttributeUserEventFeedbackV2Response>> {
