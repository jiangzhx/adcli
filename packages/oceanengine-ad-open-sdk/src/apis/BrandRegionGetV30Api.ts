...
export class BrandRegionGetV30Api {
  ...
  async openApiV30BrandRegionGetGet(advertiserId: number): Promise<BrandRegionGetV30Response> {
    const response = await this.openApiV30BrandRegionGetGetWithHttpInfo(advertiserId);
    return response.data;
  }

  async openApiV30BrandRegionGetGetWithHttpInfo(advertiserId: number): Promise<ApiResponse<BrandRegionGetV30Response>> {
