...
export class BrandCustomAudienceListV30Api {
  ...
  async openApiV30BrandCustomAudienceListGet(advertiserId: number): Promise<BrandCustomAudienceListV30Response> {
    const response = await this.openApiV30BrandCustomAudienceListGetWithHttpInfo(advertiserId);
    return response.data;
  }

  async openApiV30BrandCustomAudienceListGetWithHttpInfo(advertiserId: number): Promise<ApiResponse<BrandCustomAudienceListV30Response>> {
