...
export class DmpCustomAudienceCopyV2Api {
  ...
  async openApi2DmpCustomAudienceCopyPost(request: DmpCustomAudienceCopyV2Request): Promise<DmpCustomAudienceCopyV2Response> {
    const response = await this.openApi2DmpCustomAudienceCopyPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2DmpCustomAudienceCopyPostWithHttpInfo(request: DmpCustomAudienceCopyV2Request): Promise<ApiResponse<DmpCustomAudienceCopyV2Response>> {
