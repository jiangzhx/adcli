...
export class ToolsClueInfoUpdateV2Api {
  ...
  async openApi2ToolsClueInfoUpdatePost(request: ToolsClueInfoUpdateV2Request): Promise<ToolsClueInfoUpdateV2Response> {
    const response = await this.openApi2ToolsClueInfoUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsClueInfoUpdatePostWithHttpInfo(request: ToolsClueInfoUpdateV2Request): Promise<ApiResponse<ToolsClueInfoUpdateV2Response>> {
