...
export class LocalPromotionUpdateV30Api {
  ...
  async openApiV30LocalPromotionUpdatePost(request: LocalPromotionUpdateV30Request): Promise<LocalPromotionUpdateV30Response> {
    const response = await this.openApiV30LocalPromotionUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30LocalPromotionUpdatePostWithHttpInfo(request: LocalPromotionUpdateV30Request): Promise<ApiResponse<LocalPromotionUpdateV30Response>> {
