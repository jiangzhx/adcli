...
export class QianchuanUniPromotionAuthInitV10Api {
  ...
  async openApiV10QianchuanUniPromotionAuthInitPost(request: QianchuanUniPromotionAuthInitV10Request): Promise<QianchuanUniPromotionAuthInitV10Response> {
    const response = await this.openApiV10QianchuanUniPromotionAuthInitPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniPromotionAuthInitPostWithHttpInfo(request: QianchuanUniPromotionAuthInitV10Request): Promise<ApiResponse<QianchuanUniPromotionAuthInitV10Response>> {
