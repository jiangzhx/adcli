...
export class PromotionUpdateV30Api {
  ...
  async openApiV30PromotionUpdatePost(request: PromotionUpdateV30Request): Promise<PromotionUpdateV30Response> {
    const response = await this.openApiV30PromotionUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30PromotionUpdatePostWithHttpInfo(request: PromotionUpdateV30Request): Promise<ApiResponse<PromotionUpdateV30Response>> {
