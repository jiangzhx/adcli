...
export class AudiencePackageDeleteV2Api {
  ...
  async openApi2AudiencePackageDeletePost(request: AudiencePackageDeleteV2Request): Promise<AudiencePackageDeleteV2Response> {
    const response = await this.openApi2AudiencePackageDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2AudiencePackageDeletePostWithHttpInfo(request: AudiencePackageDeleteV2Request): Promise<ApiResponse<AudiencePackageDeleteV2Response>> {
