...
export class ToolsMaterialRaiseStopV30Api {
  ...
  async openApiV30ToolsMaterialRaiseStopPost(request: ToolsMaterialRaiseStopV30Request): Promise<ToolsMaterialRaiseStopV30Response> {
    const response = await this.openApiV30ToolsMaterialRaiseStopPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsMaterialRaiseStopPostWithHttpInfo(request: ToolsMaterialRaiseStopV30Request): Promise<ApiResponse<ToolsMaterialRaiseStopV30Response>> {
