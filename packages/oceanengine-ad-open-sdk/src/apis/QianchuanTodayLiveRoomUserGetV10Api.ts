...
export interface OpenApiV10QianchuanTodayLiveRoomUserGetGetRequest {
  advertiserId: number;
  roomId: number;
...
export class QianchuanTodayLiveRoomUserGetV10Api {
  ...
  async openApiV10QianchuanTodayLiveRoomUserGetGet(request: OpenApiV10QianchuanTodayLiveRoomUserGetGetRequest): Promise<QianchuanTodayLiveRoomUserGetV10Response> {
    const response = await this.openApiV10QianchuanTodayLiveRoomUserGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanTodayLiveRoomUserGetGetWithHttpInfo(request: OpenApiV10QianchuanTodayLiveRoomUserGetGetRequest): Promise<ApiResponse<QianchuanTodayLiveRoomUserGetV10Response>> {
