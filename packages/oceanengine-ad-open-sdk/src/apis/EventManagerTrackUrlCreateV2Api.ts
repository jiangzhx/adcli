...
export class EventManagerTrackUrlCreateV2Api {
  ...
  async openApi2EventManagerTrackUrlCreatePost(request: EventManagerTrackUrlCreateV2Request): Promise<EventManagerTrackUrlCreateV2Response> {
    const response = await this.openApi2EventManagerTrackUrlCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2EventManagerTrackUrlCreatePostWithHttpInfo(request: EventManagerTrackUrlCreateV2Request): Promise<ApiResponse<EventManagerTrackUrlCreateV2Response>> {
