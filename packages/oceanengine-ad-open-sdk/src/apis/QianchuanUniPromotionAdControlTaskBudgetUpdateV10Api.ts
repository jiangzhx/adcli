...
export class QianchuanUniPromotionAdControlTaskBudgetUpdateV10Api {
  ...
  async openApiV10QianchuanUniPromotionAdControlTaskBudgetUpdatePost(request: QianchuanUniPromotionAdControlTaskBudgetUpdateV10Request): Promise<QianchuanUniPromotionAdControlTaskBudgetUpdateV10Response> {
    const response = await this.openApiV10QianchuanUniPromotionAdControlTaskBudgetUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniPromotionAdControlTaskBudgetUpdatePostWithHttpInfo(request: QianchuanUniPromotionAdControlTaskBudgetUpdateV10Request): Promise<ApiResponse<QianchuanUniPromotionAdControlTaskBudgetUpdateV10Response>> {
