...
export class DpaEbpProductUpdateV30Api {
  ...
  async openApiV30DpaEbpProductUpdatePost(request: DpaEbpProductUpdateV30Request): Promise<DpaEbpProductUpdateV30Response> {
    const response = await this.openApiV30DpaEbpProductUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30DpaEbpProductUpdatePostWithHttpInfo(request: DpaEbpProductUpdateV30Request): Promise<ApiResponse<DpaEbpProductUpdateV30Response>> {
