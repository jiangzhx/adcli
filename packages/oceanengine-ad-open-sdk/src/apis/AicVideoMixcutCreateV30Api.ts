...
export class AicVideoMixcutCreateV30Api {
  ...
  async openApiV30AicVideoMixcutCreatePost(request: AicVideoMixcutCreateV30Request): Promise<AicVideoMixcutCreateV30Response> {
    const response = await this.openApiV30AicVideoMixcutCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30AicVideoMixcutCreatePostWithHttpInfo(request: AicVideoMixcutCreateV30Request): Promise<ApiResponse<AicVideoMixcutCreateV30Response>> {
