...
export class AdvertiserQualificationSelectV2V2Api {
  ...
  async openApi2AdvertiserQualificationSelectV2Get(request: OpenApi2AdvertiserQualificationSelectV2GetRequest): Promise<AdvertiserQualificationSelectV2V2Response> {
    const response = await this.openApi2AdvertiserQualificationSelectV2GetWithHttpInfo(request);
    return response.data;
  }

  async openApi2AdvertiserQualificationSelectV2GetWithHttpInfo(request: OpenApi2AdvertiserQualificationSelectV2GetRequest): Promise<ApiResponse<AdvertiserQualificationSelectV2V2Response>> {
