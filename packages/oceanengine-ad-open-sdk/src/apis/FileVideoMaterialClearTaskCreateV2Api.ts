...
export class FileVideoMaterialClearTaskCreateV2Api {
  ...
  async openApi2FileVideoMaterialClearTaskCreatePost(request: FileVideoMaterialClearTaskCreateV2Request): Promise<FileVideoMaterialClearTaskCreateV2Response> {
    const response = await this.openApi2FileVideoMaterialClearTaskCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2FileVideoMaterialClearTaskCreatePostWithHttpInfo(request: FileVideoMaterialClearTaskCreateV2Request): Promise<ApiResponse<FileVideoMaterialClearTaskCreateV2Response>> {
