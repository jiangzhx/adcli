...
export class ToolsAssetLinkListV30Api {
  ...
  async openApiV30ToolsAssetLinkListGet(request: OpenApiV30ToolsAssetLinkListGetRequest): Promise<ToolsAssetLinkListV30Response> {
    const response = await this.openApiV30ToolsAssetLinkListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsAssetLinkListGetWithHttpInfo(request: OpenApiV30ToolsAssetLinkListGetRequest): Promise<ApiResponse<ToolsAssetLinkListV30Response>> {
