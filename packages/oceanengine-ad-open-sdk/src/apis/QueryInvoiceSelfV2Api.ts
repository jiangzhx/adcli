...
export class QueryInvoiceSelfV2Api {
  ...
  async openApi2QueryInvoiceSelfGet(request: OpenApi2QueryInvoiceSelfGetRequest): Promise<QueryInvoiceSelfV2Response> {
    const response = await this.openApi2QueryInvoiceSelfGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2QueryInvoiceSelfGetWithHttpInfo(request: OpenApi2QueryInvoiceSelfGetRequest): Promise<ApiResponse<QueryInvoiceSelfV2Response>> {
