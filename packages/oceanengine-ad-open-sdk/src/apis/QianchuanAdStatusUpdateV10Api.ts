...
export class QianchuanAdStatusUpdateV10Api {
  ...
  async openApiV10QianchuanAdStatusUpdatePost(request: QianchuanAdStatusUpdateV10Request): Promise<QianchuanAdStatusUpdateV10Response> {
    const response = await this.openApiV10QianchuanAdStatusUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanAdStatusUpdatePostWithHttpInfo(request: QianchuanAdStatusUpdateV10Request): Promise<ApiResponse<QianchuanAdStatusUpdateV10Response>> {
