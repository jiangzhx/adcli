...
export class EventManagerAuthAddPublicKeyV2Api {
  ...
  async openApi2EventManagerAuthAddPublicKeyPost(request: EventManagerAuthAddPublicKeyV2Request): Promise<EventManagerAuthAddPublicKeyV2Response> {
    const response = await this.openApi2EventManagerAuthAddPublicKeyPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2EventManagerAuthAddPublicKeyPostWithHttpInfo(request: EventManagerAuthAddPublicKeyV2Request): Promise<ApiResponse<EventManagerAuthAddPublicKeyV2Response>> {
