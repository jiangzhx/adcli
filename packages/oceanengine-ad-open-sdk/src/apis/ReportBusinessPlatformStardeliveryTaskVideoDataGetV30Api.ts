...
export class ReportBusinessPlatformStardeliveryTaskVideoDataGetV30Api {
  ...
  async openApiV30ReportBusinessPlatformStardeliveryTaskVideoDataGetGet(request: OpenApiV30ReportBusinessPlatformStardeliveryTaskVideoDataGetGetRequest): Promise<ReportBusinessPlatformStardeliveryTaskVideoDataGetV30Response> {
    const response = await this.openApiV30ReportBusinessPlatformStardeliveryTaskVideoDataGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportBusinessPlatformStardeliveryTaskVideoDataGetGetWithHttpInfo(request: OpenApiV30ReportBusinessPlatformStardeliveryTaskVideoDataGetGetRequest): Promise<ApiResponse<ReportBusinessPlatformStardeliveryTaskVideoDataGetV30Response>> {
