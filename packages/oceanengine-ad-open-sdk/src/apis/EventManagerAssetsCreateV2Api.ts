...
export class EventManagerAssetsCreateV2Api {
  ...
  async openApi2EventManagerAssetsCreatePost(request: EventManagerAssetsCreateV2Request): Promise<EventManagerAssetsCreateV2Response> {
    const response = await this.openApi2EventManagerAssetsCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2EventManagerAssetsCreatePostWithHttpInfo(request: EventManagerAssetsCreateV2Request): Promise<ApiResponse<EventManagerAssetsCreateV2Response>> {
