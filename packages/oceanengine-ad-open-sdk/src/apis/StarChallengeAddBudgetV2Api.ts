...
export class StarChallengeAddBudgetV2Api {
  ...
  async openApi2StarChallengeAddBudgetPost(request: StarChallengeAddBudgetV2Request): Promise<StarChallengeAddBudgetV2Response> {
    const response = await this.openApi2StarChallengeAddBudgetPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarChallengeAddBudgetPostWithHttpInfo(request: StarChallengeAddBudgetV2Request): Promise<ApiResponse<StarChallengeAddBudgetV2Response>> {
