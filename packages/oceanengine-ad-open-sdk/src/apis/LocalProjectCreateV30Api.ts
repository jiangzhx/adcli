...
export class LocalProjectCreateV30Api {
  ...
  async openApiV30LocalProjectCreatePost(request: LocalProjectCreateV30Request): Promise<LocalProjectCreateV30Response> {
    const response = await this.openApiV30LocalProjectCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30LocalProjectCreatePostWithHttpInfo(request: LocalProjectCreateV30Request): Promise<ApiResponse<LocalProjectCreateV30Response>> {
