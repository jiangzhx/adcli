...
export class ReportBrandAgentDataV30Api {
  ...
  async openApiV30ReportBrandAgentDataGet(request: OpenApiV30ReportBrandAgentDataGetRequest): Promise<ReportBrandAgentDataV30Response> {
    const response = await this.openApiV30ReportBrandAgentDataGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportBrandAgentDataGetWithHttpInfo(request: OpenApiV30ReportBrandAgentDataGetRequest): Promise<ApiResponse<ReportBrandAgentDataV30Response>> {
