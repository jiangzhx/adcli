...
export class CustomerCenterFundTransferSeqCommitV2Api {
  ...
  async openApi2CustomerCenterFundTransferSeqCommitPost(request: CustomerCenterFundTransferSeqCommitV2Request): Promise<CustomerCenterFundTransferSeqCommitV2Response> {
    const response = await this.openApi2CustomerCenterFundTransferSeqCommitPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2CustomerCenterFundTransferSeqCommitPostWithHttpInfo(request: CustomerCenterFundTransferSeqCommitV2Request): Promise<ApiResponse<CustomerCenterFundTransferSeqCommitV2Response>> {
