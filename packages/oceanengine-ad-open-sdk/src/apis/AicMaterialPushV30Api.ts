...
export class AicMaterialPushV30Api {
  ...
  async openApiV30AicMaterialPushPost(request: AicMaterialPushV30Request): Promise<AicMaterialPushV30Response> {
    const response = await this.openApiV30AicMaterialPushPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30AicMaterialPushPostWithHttpInfo(request: AicMaterialPushV30Request): Promise<ApiResponse<AicMaterialPushV30Response>> {
