...
export class ToolsAppManagementAndroidBasicPackageUpdateV2Api {
  ...
  async openApi2ToolsAppManagementAndroidBasicPackageUpdatePost(request: ToolsAppManagementAndroidBasicPackageUpdateV2Request): Promise<ToolsAppManagementAndroidBasicPackageUpdateV2Response> {
    const response = await this.openApi2ToolsAppManagementAndroidBasicPackageUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAppManagementAndroidBasicPackageUpdatePostWithHttpInfo(request: ToolsAppManagementAndroidBasicPackageUpdateV2Request): Promise<ApiResponse<ToolsAppManagementAndroidBasicPackageUpdateV2Response>> {
