...
export class ToolsPromotionRaiseStopV30Api {
  ...
  async openApiV30ToolsPromotionRaiseStopPost(request: ToolsPromotionRaiseStopV30Request): Promise<ToolsPromotionRaiseStopV30Response> {
    const response = await this.openApiV30ToolsPromotionRaiseStopPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsPromotionRaiseStopPostWithHttpInfo(request: ToolsPromotionRaiseStopV30Request): Promise<ApiResponse<ToolsPromotionRaiseStopV30Response>> {
