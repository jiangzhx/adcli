...
export class UniProjectUpdateV30Api {
  ...
  async openApiV30UniProjectUpdatePost(request: UniProjectUpdateV30Request): Promise<UniProjectUpdateV30Response> {
    const response = await this.openApiV30UniProjectUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30UniProjectUpdatePostWithHttpInfo(request: UniProjectUpdateV30Request): Promise<ApiResponse<UniProjectUpdateV30Response>> {
