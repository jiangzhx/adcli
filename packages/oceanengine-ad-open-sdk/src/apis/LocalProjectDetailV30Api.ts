...
export class LocalProjectDetailV30Api {
  ...
  async openApiV30LocalProjectDetailGet(request: OpenApiV30LocalProjectDetailGetRequest): Promise<LocalProjectDetailV30Response> {
    const response = await this.openApiV30LocalProjectDetailGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30LocalProjectDetailGetWithHttpInfo(request: OpenApiV30LocalProjectDetailGetRequest): Promise<ApiResponse<LocalProjectDetailV30Response>> {
