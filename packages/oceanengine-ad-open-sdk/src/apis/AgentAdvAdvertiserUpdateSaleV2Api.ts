...
export class AgentAdvAdvertiserUpdateSaleV2Api {
  ...
  async openApi2AgentAdvAdvertiserUpdateSalePost(request: AgentAdvAdvertiserUpdateSaleV2Request): Promise<AgentAdvAdvertiserUpdateSaleV2Response> {
    const response = await this.openApi2AgentAdvAdvertiserUpdateSalePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2AgentAdvAdvertiserUpdateSalePostWithHttpInfo(request: AgentAdvAdvertiserUpdateSaleV2Request): Promise<ApiResponse<AgentAdvAdvertiserUpdateSaleV2Response>> {
