...
export interface OpenApi2ToolsThirdSiteUpdatePostRequest {
...
export class ToolsThirdSiteUpdateV2Api {
  ...
  async openApi2ToolsThirdSiteUpdatePost(request: OpenApi2ToolsThirdSiteUpdatePostRequest): Promise<ToolsThirdSiteUpdateV2Response> {
    const response = await this.openApi2ToolsThirdSiteUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsThirdSiteUpdatePostWithHttpInfo(request: OpenApi2ToolsThirdSiteUpdatePostRequest): Promise<ApiResponse<ToolsThirdSiteUpdateV2Response>> {
