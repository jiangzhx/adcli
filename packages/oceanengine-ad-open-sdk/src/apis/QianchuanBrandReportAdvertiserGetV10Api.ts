...
export interface OpenApiV10QianchuanBrandReportAdvertiserGetGetRequest {
  advertiserId: number;
  startDate: string;
  endDate: string;
  fields: string[];
...
export class QianchuanBrandReportAdvertiserGetV10Api {
  ...
  async openApiV10QianchuanBrandReportAdvertiserGetGet(request: OpenApiV10QianchuanBrandReportAdvertiserGetGetRequest): Promise<QianchuanBrandReportAdvertiserGetV10Response> {
    const response = await this.openApiV10QianchuanBrandReportAdvertiserGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanBrandReportAdvertiserGetGetWithHttpInfo(request: OpenApiV10QianchuanBrandReportAdvertiserGetGetRequest): Promise<ApiResponse<QianchuanBrandReportAdvertiserGetV10Response>> {
