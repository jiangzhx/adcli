...
export interface OpenApi2AgentAdvCostReportListQueryPostRequest {
...
export class AgentAdvCostReportListQueryV2Api {
  ...
  async openApi2AgentAdvCostReportListQueryPost(request: OpenApi2AgentAdvCostReportListQueryPostRequest): Promise<AgentAdvCostReportListQueryV2Response> {
    const response = await this.openApi2AgentAdvCostReportListQueryPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2AgentAdvCostReportListQueryPostWithHttpInfo(request: OpenApi2AgentAdvCostReportListQueryPostRequest): Promise<ApiResponse<AgentAdvCostReportListQueryV2Response>> {
