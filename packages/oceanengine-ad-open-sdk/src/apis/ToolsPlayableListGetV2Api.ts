...
export class ToolsPlayableListGetV2Api {
  ...
  async openApi2ToolsPlayableListGetGet(request: OpenApi2ToolsPlayableListGetGetRequest): Promise<ToolsPlayableListGetV2Response> {
    const response = await this.openApi2ToolsPlayableListGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsPlayableListGetGetWithHttpInfo(request: OpenApi2ToolsPlayableListGetGetRequest): Promise<ApiResponse<ToolsPlayableListGetV2Response>> {
