...
export class StarOrderApproveResourceV2Api {
  ...
  async openApi2StarOrderApproveResourcePost(request: StarOrderApproveResourceV2Request): Promise<StarOrderApproveResourceV2Response> {
    const response = await this.openApi2StarOrderApproveResourcePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarOrderApproveResourcePostWithHttpInfo(request: StarOrderApproveResourceV2Request): Promise<ApiResponse<StarOrderApproveResourceV2Response>> {
