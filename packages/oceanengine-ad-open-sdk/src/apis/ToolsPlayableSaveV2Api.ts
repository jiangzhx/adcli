...
export class ToolsPlayableSaveV2Api {
  ...
  async openApi2ToolsPlayableSavePost(request: ToolsPlayableSaveV2Request): Promise<ToolsPlayableSaveV2Response> {
    const response = await this.openApi2ToolsPlayableSavePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsPlayableSavePostWithHttpInfo(request: ToolsPlayableSaveV2Request): Promise<ApiResponse<ToolsPlayableSaveV2Response>> {
