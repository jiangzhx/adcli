...
export class ToolsAppManagementExtendPackageCreateV2V2Api {
  ...
  async openApi2ToolsAppManagementExtendPackageCreateV2Post(request: ToolsAppManagementExtendPackageCreateV2V2Request): Promise<ToolsAppManagementExtendPackageCreateV2V2Response> {
    const response = await this.openApi2ToolsAppManagementExtendPackageCreateV2PostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAppManagementExtendPackageCreateV2PostWithHttpInfo(request: ToolsAppManagementExtendPackageCreateV2V2Request): Promise<ApiResponse<ToolsAppManagementExtendPackageCreateV2V2Response>> {
