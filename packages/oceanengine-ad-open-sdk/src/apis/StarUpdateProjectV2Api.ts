...
export class StarUpdateProjectV2Api {
  ...
  async openApi2StarUpdateProjectPost(request: StarUpdateProjectV2Request): Promise<StarUpdateProjectV2Response> {
    const response = await this.openApi2StarUpdateProjectPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarUpdateProjectPostWithHttpInfo(request: StarUpdateProjectV2Request): Promise<ApiResponse<StarUpdateProjectV2Response>> {
