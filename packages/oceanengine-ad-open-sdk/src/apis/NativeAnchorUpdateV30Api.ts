...
export class NativeAnchorUpdateV30Api {
  ...
  async openApiV30NativeAnchorUpdatePost(request: NativeAnchorUpdateV30Request): Promise<NativeAnchorUpdateV30Response> {
    const response = await this.openApiV30NativeAnchorUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30NativeAnchorUpdatePostWithHttpInfo(request: NativeAnchorUpdateV30Request): Promise<ApiResponse<NativeAnchorUpdateV30Response>> {
