...
export class StarVasCreateBoostItemGroupV2Api {
  ...
  async openApi2StarVasCreateBoostItemGroupPost(request: StarVasCreateBoostItemGroupV2Request): Promise<StarVasCreateBoostItemGroupV2Response> {
    const response = await this.openApi2StarVasCreateBoostItemGroupPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarVasCreateBoostItemGroupPostWithHttpInfo(request: StarVasCreateBoostItemGroupV2Request): Promise<ApiResponse<StarVasCreateBoostItemGroupV2Response>> {
