...
export class StarOrderPushResourceV2Api {
  ...
  async openApi2StarOrderPushResourcePost(request: StarOrderPushResourceV2Request): Promise<StarOrderPushResourceV2Response> {
    const response = await this.openApi2StarOrderPushResourcePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarOrderPushResourcePostWithHttpInfo(request: StarOrderPushResourceV2Request): Promise<ApiResponse<StarOrderPushResourceV2Response>> {
