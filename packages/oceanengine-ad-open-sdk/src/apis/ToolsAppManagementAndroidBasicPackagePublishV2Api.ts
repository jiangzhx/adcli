...
export class ToolsAppManagementAndroidBasicPackagePublishV2Api {
  ...
  async openApi2ToolsAppManagementAndroidBasicPackagePublishPost(request: ToolsAppManagementAndroidBasicPackagePublishV2Request): Promise<ToolsAppManagementAndroidBasicPackagePublishV2Response> {
    const response = await this.openApi2ToolsAppManagementAndroidBasicPackagePublishPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAppManagementAndroidBasicPackagePublishPostWithHttpInfo(request: ToolsAppManagementAndroidBasicPackagePublishV2Request): Promise<ApiResponse<ToolsAppManagementAndroidBasicPackagePublishV2Response>> {
