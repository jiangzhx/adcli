...
export class SubscribeAccountsListV30Api {
  ...
  async openApiV30SubscribeAccountsListGet(request: OpenApiV30SubscribeAccountsListGetRequest): Promise<SubscribeAccountsListV30Response> {
    const response = await this.openApiV30SubscribeAccountsListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30SubscribeAccountsListGetWithHttpInfo(request: OpenApiV30SubscribeAccountsListGetRequest): Promise<ApiResponse<SubscribeAccountsListV30Response>> {
