...
export class StarCreateProjectV2Api {
  ...
  async openApi2StarCreateProjectPost(request: StarCreateProjectV2Request): Promise<StarCreateProjectV2Response> {
    const response = await this.openApi2StarCreateProjectPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarCreateProjectPostWithHttpInfo(request: StarCreateProjectV2Request): Promise<ApiResponse<StarCreateProjectV2Response>> {
