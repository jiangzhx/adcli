...
export class ToolsClueWebrtcTokenGetV2Api {
  ...
  async openApi2ToolsClueWebrtcTokenGetPost(request: ToolsClueWebrtcTokenGetV2Request): Promise<ToolsClueWebrtcTokenGetV2Response> {
    const response = await this.openApi2ToolsClueWebrtcTokenGetPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsClueWebrtcTokenGetPostWithHttpInfo(request: ToolsClueWebrtcTokenGetV2Request): Promise<ApiResponse<ToolsClueWebrtcTokenGetV2Response>> {
