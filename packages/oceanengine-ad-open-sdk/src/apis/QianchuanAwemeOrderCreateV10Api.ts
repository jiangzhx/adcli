...
export class QianchuanAwemeOrderCreateV10Api {
  ...
  async openApiV10QianchuanAwemeOrderCreatePost(request: QianchuanAwemeOrderCreateV10Request): Promise<QianchuanAwemeOrderCreateV10Response> {
    const response = await this.openApiV10QianchuanAwemeOrderCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanAwemeOrderCreatePostWithHttpInfo(request: QianchuanAwemeOrderCreateV10Request): Promise<ApiResponse<QianchuanAwemeOrderCreateV10Response>> {
