...
export class ToolsWechatAppletListV30Api {
  ...
  async openApiV30ToolsWechatAppletListGet(request: OpenApiV30ToolsWechatAppletListGetRequest): Promise<ToolsWechatAppletListV30Response> {
    const response = await this.openApiV30ToolsWechatAppletListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsWechatAppletListGetWithHttpInfo(request: OpenApiV30ToolsWechatAppletListGetRequest): Promise<ApiResponse<ToolsWechatAppletListV30Response>> {
