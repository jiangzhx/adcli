...
export class DouplusOrderRenewV30Api {
  ...
  async openApiV30DouplusOrderRenewPost(request: DouplusOrderRenewV30Request): Promise<DouplusOrderRenewV30Response> {
    const response = await this.openApiV30DouplusOrderRenewPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30DouplusOrderRenewPostWithHttpInfo(request: DouplusOrderRenewV30Request): Promise<ApiResponse<DouplusOrderRenewV30Response>> {
