...
export class StarDemandOmExpandChallengeV2Api {
  ...
  async openApi2StarDemandOmExpandChallengePost(request: StarDemandOmExpandChallengeV2Request): Promise<StarDemandOmExpandChallengeV2Response> {
    const response = await this.openApi2StarDemandOmExpandChallengePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarDemandOmExpandChallengePostWithHttpInfo(request: StarDemandOmExpandChallengeV2Request): Promise<ApiResponse<StarDemandOmExpandChallengeV2Response>> {
