...
export class AgentAdvertiserUnassignV2Api {
  ...
  async openApi2AgentAdvertiserUnassignPost(request: AgentAdvertiserUnassignV2Request): Promise<AgentAdvertiserUnassignV2Response> {
    const response = await this.openApi2AgentAdvertiserUnassignPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2AgentAdvertiserUnassignPostWithHttpInfo(request: AgentAdvertiserUnassignV2Request): Promise<ApiResponse<AgentAdvertiserUnassignV2Response>> {
