...
export class AdvertiserPublicInfoV2Api {
  ...
  async openApi2AdvertiserPublicInfoGet(request: OpenApi2AdvertiserPublicInfoGetRequest): Promise<AdvertiserPublicInfoV2Response> {
    const response = await this.openApi2AdvertiserPublicInfoGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2AdvertiserPublicInfoGetWithHttpInfo(request: OpenApi2AdvertiserPublicInfoGetRequest): Promise<ApiResponse<AdvertiserPublicInfoV2Response>> {
