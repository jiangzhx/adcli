...
export class LocalImSendMsgV30Api {
  ...
  async openApiV30LocalImSendMsgPost(request: LocalImSendMsgV30Request): Promise<LocalImSendMsgV30Response> {
    const response = await this.openApiV30LocalImSendMsgPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30LocalImSendMsgPostWithHttpInfo(request: LocalImSendMsgV30Request): Promise<ApiResponse<LocalImSendMsgV30Response>> {
