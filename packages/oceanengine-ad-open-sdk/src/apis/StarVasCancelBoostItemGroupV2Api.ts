...
export class StarVasCancelBoostItemGroupV2Api {
  ...
  async openApi2StarVasCancelBoostItemGroupPost(request: StarVasCancelBoostItemGroupV2Request): Promise<StarVasCancelBoostItemGroupV2Response> {
    const response = await this.openApi2StarVasCancelBoostItemGroupPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarVasCancelBoostItemGroupPostWithHttpInfo(request: StarVasCancelBoostItemGroupV2Request): Promise<ApiResponse<StarVasCancelBoostItemGroupV2Response>> {
