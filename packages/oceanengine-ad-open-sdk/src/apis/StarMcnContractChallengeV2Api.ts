...
export class StarMcnContractChallengeV2Api {
  ...
  async openApi2StarMcnContractChallengePost(request: StarMcnContractChallengeV2Request): Promise<StarMcnContractChallengeV2Response> {
    const response = await this.openApi2StarMcnContractChallengePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarMcnContractChallengePostWithHttpInfo(request: StarMcnContractChallengeV2Request): Promise<ApiResponse<StarMcnContractChallengeV2Response>> {
