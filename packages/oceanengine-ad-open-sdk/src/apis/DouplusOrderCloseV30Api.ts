...
export class DouplusOrderCloseV30Api {
  ...
  async openApiV30DouplusOrderClosePost(request: DouplusOrderCloseV30Request): Promise<DouplusOrderCloseV30Response> {
    const response = await this.openApiV30DouplusOrderClosePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30DouplusOrderClosePostWithHttpInfo(request: DouplusOrderCloseV30Request): Promise<ApiResponse<DouplusOrderCloseV30Response>> {
