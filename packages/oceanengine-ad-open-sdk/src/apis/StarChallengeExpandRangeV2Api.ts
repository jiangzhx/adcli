...
export class StarChallengeExpandRangeV2Api {
  ...
  async openApi2StarChallengeExpandRangePost(request: StarChallengeExpandRangeV2Request): Promise<StarChallengeExpandRangeV2Response> {
    const response = await this.openApi2StarChallengeExpandRangePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarChallengeExpandRangePostWithHttpInfo(request: StarChallengeExpandRangeV2Request): Promise<ApiResponse<StarChallengeExpandRangeV2Response>> {
