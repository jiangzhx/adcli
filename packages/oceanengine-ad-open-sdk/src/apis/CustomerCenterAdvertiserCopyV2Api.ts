...
export class CustomerCenterAdvertiserCopyV2Api {
  ...
  async openApi2CustomerCenterAdvertiserCopyPost(request: CustomerCenterAdvertiserCopyV2Request): Promise<CustomerCenterAdvertiserCopyV2Response> {
    const response = await this.openApi2CustomerCenterAdvertiserCopyPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2CustomerCenterAdvertiserCopyPostWithHttpInfo(request: CustomerCenterAdvertiserCopyV2Request): Promise<ApiResponse<CustomerCenterAdvertiserCopyV2Response>> {
