...
export class ToolsAipThirdSiteCreateV2Api {
  ...
  async openApi2ToolsAipThirdSiteCreatePost(request: ToolsAipThirdSiteCreateV2Request): Promise<ToolsAipThirdSiteCreateV2Response> {
    const response = await this.openApi2ToolsAipThirdSiteCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAipThirdSiteCreatePostWithHttpInfo(request: ToolsAipThirdSiteCreateV2Request): Promise<ApiResponse<ToolsAipThirdSiteCreateV2Response>> {
