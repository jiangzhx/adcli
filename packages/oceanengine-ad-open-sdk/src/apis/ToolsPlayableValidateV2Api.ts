...
export class ToolsPlayableValidateV2Api {
  ...
  async openApi2ToolsPlayableValidateGet(request: OpenApi2ToolsPlayableValidateGetRequest): Promise<ToolsPlayableValidateV2Response> {
    const response = await this.openApi2ToolsPlayableValidateGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsPlayableValidateGetWithHttpInfo(request: OpenApi2ToolsPlayableValidateGetRequest): Promise<ApiResponse<ToolsPlayableValidateV2Response>> {
