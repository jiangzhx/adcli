...
export class ToolsClueLiteContactRecordV2Api {
  ...
  async openApi2ToolsClueLiteContactRecordPost(request: ToolsClueLiteContactRecordV2Request): Promise<ToolsClueLiteContactRecordV2Response> {
    const response = await this.openApi2ToolsClueLiteContactRecordPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsClueLiteContactRecordPostWithHttpInfo(request: ToolsClueLiteContactRecordV2Request): Promise<ApiResponse<ToolsClueLiteContactRecordV2Response>> {
