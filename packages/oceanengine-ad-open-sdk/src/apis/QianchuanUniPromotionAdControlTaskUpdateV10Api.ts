...
export class QianchuanUniPromotionAdControlTaskUpdateV10Api {
  ...
  async openApiV10QianchuanUniPromotionAdControlTaskUpdatePost(request: QianchuanUniPromotionAdControlTaskUpdateV10Request): Promise<QianchuanUniPromotionAdControlTaskUpdateV10Response> {
    const response = await this.openApiV10QianchuanUniPromotionAdControlTaskUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniPromotionAdControlTaskUpdatePostWithHttpInfo(request: QianchuanUniPromotionAdControlTaskUpdateV10Request): Promise<ApiResponse<QianchuanUniPromotionAdControlTaskUpdateV10Response>> {
