...
export class ClueCouponEmployeeCreateV2Api {
  ...
  async openApi2ClueCouponEmployeeCreatePost(request: ClueCouponEmployeeCreateV2Request): Promise<ClueCouponEmployeeCreateV2Response> {
    const response = await this.openApi2ClueCouponEmployeeCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ClueCouponEmployeeCreatePostWithHttpInfo(request: ClueCouponEmployeeCreateV2Request): Promise<ApiResponse<ClueCouponEmployeeCreateV2Response>> {
