...
export class StarMcnGetUnparticipatedTaskV2Api {
  ...
  async openApi2StarMcnGetUnparticipatedTaskGet(request: OpenApi2StarMcnGetUnparticipatedTaskGetRequest): Promise<StarMcnGetUnparticipatedTaskV2Response> {
    const response = await this.openApi2StarMcnGetUnparticipatedTaskGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarMcnGetUnparticipatedTaskGetWithHttpInfo(request: OpenApi2StarMcnGetUnparticipatedTaskGetRequest): Promise<ApiResponse<StarMcnGetUnparticipatedTaskV2Response>> {
