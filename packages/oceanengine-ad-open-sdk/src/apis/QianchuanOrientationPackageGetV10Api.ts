...
export class QianchuanOrientationPackageGetV10Api {
  ...
  async openApiV10QianchuanOrientationPackageGetGet(request: OpenApiV10QianchuanOrientationPackageGetGetRequest): Promise<QianchuanOrientationPackageGetV10Response> {
    const response = await this.openApiV10QianchuanOrientationPackageGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanOrientationPackageGetGetWithHttpInfo(request: OpenApiV10QianchuanOrientationPackageGetGetRequest): Promise<ApiResponse<QianchuanOrientationPackageGetV10Response>> {
