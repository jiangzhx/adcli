...
export class FileMaterialBindV2Api {
  ...
  async openApi2FileMaterialBindPost(request: FileMaterialBindV2Request): Promise<FileMaterialBindV2Response> {
    const response = await this.openApi2FileMaterialBindPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2FileMaterialBindPostWithHttpInfo(request: FileMaterialBindV2Request): Promise<ApiResponse<FileMaterialBindV2Response>> {
