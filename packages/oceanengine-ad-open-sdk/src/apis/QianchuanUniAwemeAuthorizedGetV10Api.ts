...
export interface OpenApiV10QianchuanUniAwemeAuthorizedGetGetRequest {
...
export class QianchuanUniAwemeAuthorizedGetV10Api {
  ...
  async openApiV10QianchuanUniAwemeAuthorizedGetGet(request: OpenApiV10QianchuanUniAwemeAuthorizedGetGetRequest): Promise<QianchuanUniAwemeAuthorizedGetV10Response> {
    const response = await this.openApiV10QianchuanUniAwemeAuthorizedGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniAwemeAuthorizedGetGetWithHttpInfo(request: OpenApiV10QianchuanUniAwemeAuthorizedGetGetRequest): Promise<ApiResponse<QianchuanUniAwemeAuthorizedGetV10Response>> {
