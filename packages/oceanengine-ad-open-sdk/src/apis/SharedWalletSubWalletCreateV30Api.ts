...
export class SharedWalletSubWalletCreateV30Api {
  ...
  async openApiV30SharedWalletSubWalletCreatePost(request: SharedWalletSubWalletCreateV30Request): Promise<SharedWalletSubWalletCreateV30Response> {
    const response = await this.openApiV30SharedWalletSubWalletCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30SharedWalletSubWalletCreatePostWithHttpInfo(request: SharedWalletSubWalletCreateV30Request): Promise<ApiResponse<SharedWalletSubWalletCreateV30Response>> {
