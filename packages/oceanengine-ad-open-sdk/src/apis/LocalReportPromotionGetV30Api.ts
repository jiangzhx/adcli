...
export interface OpenApiV30LocalReportPromotionGetGetRequest {
...
export class LocalReportPromotionGetV30Api {
  ...
  async openApiV30LocalReportPromotionGetGet(request: OpenApiV30LocalReportPromotionGetGetRequest): Promise<LocalReportPromotionGetV30Response> {
    const response = await this.openApiV30LocalReportPromotionGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30LocalReportPromotionGetGetWithHttpInfo(request: OpenApiV30LocalReportPromotionGetGetRequest): Promise<ApiResponse<LocalReportPromotionGetV30Response>> {
