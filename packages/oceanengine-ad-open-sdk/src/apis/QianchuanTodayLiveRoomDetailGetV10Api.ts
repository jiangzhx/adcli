...
export class QianchuanTodayLiveRoomDetailGetV10Api {
  ...
  async openApiV10QianchuanTodayLiveRoomDetailGetGet(request: OpenApiV10QianchuanTodayLiveRoomDetailGetGetRequest): Promise<QianchuanTodayLiveRoomDetailGetV10Response> {
    const response = await this.openApiV10QianchuanTodayLiveRoomDetailGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanTodayLiveRoomDetailGetGetWithHttpInfo(request: OpenApiV10QianchuanTodayLiveRoomDetailGetGetRequest): Promise<ApiResponse<QianchuanTodayLiveRoomDetailGetV10Response>> {
