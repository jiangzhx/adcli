...
export class ToolsTaskRaiseStatusStopV2Api {
  ...
  async openApi2ToolsTaskRaiseStatusStopPost(request: ToolsTaskRaiseStatusStopV2Request): Promise<ToolsTaskRaiseStatusStopV2Response> {
    const response = await this.openApi2ToolsTaskRaiseStatusStopPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsTaskRaiseStatusStopPostWithHttpInfo(request: ToolsTaskRaiseStatusStopV2Request): Promise<ApiResponse<ToolsTaskRaiseStatusStopV2Response>> {
