...
export class ToolsClueRefundInfoQueryV2Api {
  ...
  async openApi2ToolsClueRefundInfoQueryPost(request: ToolsClueRefundInfoQueryV2Request): Promise<ToolsClueRefundInfoQueryV2Response> {
    const response = await this.openApi2ToolsClueRefundInfoQueryPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsClueRefundInfoQueryPostWithHttpInfo(request: ToolsClueRefundInfoQueryV2Request): Promise<ApiResponse<ToolsClueRefundInfoQueryV2Response>> {
