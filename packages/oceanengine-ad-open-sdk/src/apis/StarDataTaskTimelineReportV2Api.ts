...
export class StarDataTaskTimelineReportV2Api {
  ...
  async openApi2StarDataTaskTimelineReportGet(request: OpenApi2StarDataTaskTimelineReportGetRequest): Promise<StarDataTaskTimelineReportV2Response> {
    const response = await this.openApi2StarDataTaskTimelineReportGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarDataTaskTimelineReportGetWithHttpInfo(request: OpenApi2StarDataTaskTimelineReportGetRequest): Promise<ApiResponse<StarDataTaskTimelineReportV2Response>> {
