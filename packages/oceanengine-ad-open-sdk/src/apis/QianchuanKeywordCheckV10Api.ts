...
export class QianchuanKeywordCheckV10Api {
  ...
  async openApiV10QianchuanKeywordCheckPost(request: QianchuanKeywordCheckV10Request): Promise<QianchuanKeywordCheckV10Response> {
    const response = await this.openApiV10QianchuanKeywordCheckPostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanKeywordCheckPostWithHttpInfo(request: QianchuanKeywordCheckV10Request): Promise<ApiResponse<QianchuanKeywordCheckV10Response>> {
