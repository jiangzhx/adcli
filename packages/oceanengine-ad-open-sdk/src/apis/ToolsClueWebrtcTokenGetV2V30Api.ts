...
export class ToolsClueWebrtcTokenGetV2V30Api {
  ...
  async openApiV30ToolsClueWebrtcTokenGetV2Post(request: ToolsClueWebrtcTokenGetV2V30Request): Promise<ToolsClueWebrtcTokenGetV2V30Response> {
    const response = await this.openApiV30ToolsClueWebrtcTokenGetV2PostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsClueWebrtcTokenGetV2PostWithHttpInfo(request: ToolsClueWebrtcTokenGetV2V30Request): Promise<ApiResponse<ToolsClueWebrtcTokenGetV2V30Response>> {
