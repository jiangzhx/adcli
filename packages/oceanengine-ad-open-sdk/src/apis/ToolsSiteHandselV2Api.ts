...
export interface OpenApi2ToolsSiteHandselPostRequest {
...
export class ToolsSiteHandselV2Api {
  ...
  async openApi2ToolsSiteHandselPost(request: OpenApi2ToolsSiteHandselPostRequest): Promise<ToolsSiteHandselV2Response> {
    const response = await this.openApi2ToolsSiteHandselPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsSiteHandselPostWithHttpInfo(request: OpenApi2ToolsSiteHandselPostRequest): Promise<ApiResponse<ToolsSiteHandselV2Response>> {
