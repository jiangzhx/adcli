...
export interface OpenApiV10QianchuanReportAdvertiserGetGetRequest {
  advertiserId: number;
  startDate: string;
  endDate: string;
  fields: string[];
...
export class QianchuanReportAdvertiserGetV10Api {
  ...
  async openApiV10QianchuanReportAdvertiserGetGet(request: OpenApiV10QianchuanReportAdvertiserGetGetRequest): Promise<QianchuanReportAdvertiserGetV10Response> {
    const response = await this.openApiV10QianchuanReportAdvertiserGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanReportAdvertiserGetGetWithHttpInfo(request: OpenApiV10QianchuanReportAdvertiserGetGetRequest): Promise<ApiResponse<QianchuanReportAdvertiserGetV10Response>> {
