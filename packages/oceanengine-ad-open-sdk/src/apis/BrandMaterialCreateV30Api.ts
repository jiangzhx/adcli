...
export class BrandMaterialCreateV30Api {
  ...
  async openApiV30BrandMaterialCreatePost(request: BrandMaterialCreateV30Request): Promise<BrandMaterialCreateV30Response> {
    const response = await this.openApiV30BrandMaterialCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30BrandMaterialCreatePostWithHttpInfo(request: BrandMaterialCreateV30Request): Promise<ApiResponse<BrandMaterialCreateV30Response>> {
