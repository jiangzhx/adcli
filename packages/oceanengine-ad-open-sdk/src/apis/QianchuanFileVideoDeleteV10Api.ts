...
export class QianchuanFileVideoDeleteV10Api {
  ...
  async openApiV10QianchuanFileVideoDeletePost(request: QianchuanFileVideoDeleteV10Request): Promise<QianchuanFileVideoDeleteV10Response> {
    const response = await this.openApiV10QianchuanFileVideoDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanFileVideoDeletePostWithHttpInfo(request: QianchuanFileVideoDeleteV10Request): Promise<ApiResponse<QianchuanFileVideoDeleteV10Response>> {
