...
export class CreativeCustomCreativeUpdateV2Api {
  ...
  async openApi2CreativeCustomCreativeUpdatePost(request: CreativeCustomCreativeUpdateV2Request): Promise<CreativeCustomCreativeUpdateV2Response> {
    const response = await this.openApi2CreativeCustomCreativeUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2CreativeCustomCreativeUpdatePostWithHttpInfo(request: CreativeCustomCreativeUpdateV2Request): Promise<ApiResponse<CreativeCustomCreativeUpdateV2Response>> {
