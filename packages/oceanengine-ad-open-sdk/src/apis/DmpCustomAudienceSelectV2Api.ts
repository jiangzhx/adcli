...
export class DmpCustomAudienceSelectV2Api {
  ...
  async openApi2DmpCustomAudienceSelectGet(request: OpenApi2DmpCustomAudienceSelectGetRequest): Promise<DmpCustomAudienceSelectV2Response> {
    const response = await this.openApi2DmpCustomAudienceSelectGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2DmpCustomAudienceSelectGetWithHttpInfo(request: OpenApi2DmpCustomAudienceSelectGetRequest): Promise<ApiResponse<DmpCustomAudienceSelectV2Response>> {
