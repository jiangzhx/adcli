...
export interface OpenApi2DmpCustomAudienceDeletePostRequest {
...
export class DmpCustomAudienceDeleteV2Api {
  ...
  async openApi2DmpCustomAudienceDeletePost(request: OpenApi2DmpCustomAudienceDeletePostRequest): Promise<DmpCustomAudienceDeleteV2Response> {
    const response = await this.openApi2DmpCustomAudienceDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2DmpCustomAudienceDeletePostWithHttpInfo(request: OpenApi2DmpCustomAudienceDeletePostRequest): Promise<ApiResponse<DmpCustomAudienceDeleteV2Response>> {
