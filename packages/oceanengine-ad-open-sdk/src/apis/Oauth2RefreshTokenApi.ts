...
export class Oauth2RefreshTokenApi {
  ...
  async openApiOauth2RefreshTokenPost(request: Oauth2RefreshTokenRequest): Promise<Oauth2RefreshTokenResponse> {
    const response = await this.openApiOauth2RefreshTokenPostWithHttpInfo(request);
    return response.data;
  }

  async openApiOauth2RefreshTokenPostWithHttpInfo(request: Oauth2RefreshTokenRequest): Promise<ApiResponse<Oauth2RefreshTokenResponse>> {
