...
export class ToolsAppManagementUpdateAuthorizationV2Api {
  ...
  async openApi2ToolsAppManagementUpdateAuthorizationPost(request: ToolsAppManagementUpdateAuthorizationV2Request): Promise<ToolsAppManagementUpdateAuthorizationV2Response> {
    const response = await this.openApi2ToolsAppManagementUpdateAuthorizationPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsAppManagementUpdateAuthorizationPostWithHttpInfo(request: ToolsAppManagementUpdateAuthorizationV2Request): Promise<ApiResponse<ToolsAppManagementUpdateAuthorizationV2Response>> {
