...
export class AdvertiserAvatarGetV2Api {
  ...
  async openApi2AdvertiserAvatarGetGet(request: OpenApi2AdvertiserAvatarGetGetRequest): Promise<AdvertiserAvatarGetV2Response> {
    const response = await this.openApi2AdvertiserAvatarGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2AdvertiserAvatarGetGetWithHttpInfo(request: OpenApi2AdvertiserAvatarGetGetRequest): Promise<ApiResponse<AdvertiserAvatarGetV2Response>> {
