...
export interface OpenApi2StarDemanderGetRegisteredIpActsGetRequest {
  starId: number;
}
...
export class StarDemanderGetRegisteredIpActsV2Api {
  ...
  async openApi2StarDemanderGetRegisteredIpActsGet(request: OpenApi2StarDemanderGetRegisteredIpActsGetRequest): Promise<StarDemanderGetRegisteredIpActsV2Response> {
    const response = await this.openApi2StarDemanderGetRegisteredIpActsGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarDemanderGetRegisteredIpActsGetWithHttpInfo(request: OpenApi2StarDemanderGetRegisteredIpActsGetRequest): Promise<ApiResponse<StarDemanderGetRegisteredIpActsV2Response>> {
