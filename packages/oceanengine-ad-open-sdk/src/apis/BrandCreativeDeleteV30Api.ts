...
export class BrandCreativeDeleteV30Api {
  ...
  async openApiV30BrandCreativeDeletePost(request: BrandCreativeDeleteV30Request): Promise<BrandCreativeDeleteV30Response> {
    const response = await this.openApiV30BrandCreativeDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30BrandCreativeDeletePostWithHttpInfo(request: BrandCreativeDeleteV30Request): Promise<ApiResponse<BrandCreativeDeleteV30Response>> {
