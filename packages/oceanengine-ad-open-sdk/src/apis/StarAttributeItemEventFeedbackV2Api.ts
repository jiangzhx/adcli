...
export class StarAttributeItemEventFeedbackV2Api {
  ...
  async openApi2StarAttributeItemEventFeedbackPost(request: StarAttributeItemEventFeedbackV2Request): Promise<StarAttributeItemEventFeedbackV2Response> {
    const response = await this.openApi2StarAttributeItemEventFeedbackPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarAttributeItemEventFeedbackPostWithHttpInfo(request: StarAttributeItemEventFeedbackV2Request): Promise<ApiResponse<StarAttributeItemEventFeedbackV2Response>> {
