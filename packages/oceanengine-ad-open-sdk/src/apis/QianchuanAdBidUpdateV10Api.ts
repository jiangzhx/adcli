...
export class QianchuanAdBidUpdateV10Api {
  ...
  async openApiV10QianchuanAdBidUpdatePost(request: QianchuanAdBidUpdateV10Request): Promise<QianchuanAdBidUpdateV10Response> {
    const response = await this.openApiV10QianchuanAdBidUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanAdBidUpdatePostWithHttpInfo(request: QianchuanAdBidUpdateV10Request): Promise<ApiResponse<QianchuanAdBidUpdateV10Response>> {
