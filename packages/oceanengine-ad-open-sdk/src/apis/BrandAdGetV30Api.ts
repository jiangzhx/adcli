...
export class BrandAdGetV30Api {
  ...
  async openApiV30BrandAdGetGet(request: OpenApiV30BrandAdGetGetRequest): Promise<BrandAdGetV30Response> {
    const response = await this.openApiV30BrandAdGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30BrandAdGetGetWithHttpInfo(request: OpenApiV30BrandAdGetGetRequest): Promise<ApiResponse<BrandAdGetV30Response>> {
