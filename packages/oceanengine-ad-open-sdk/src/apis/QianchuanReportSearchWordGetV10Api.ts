...
export class QianchuanReportSearchWordGetV10Api {
  ...
  async openApiV10QianchuanReportSearchWordGetGet(request: OpenApiV10QianchuanReportSearchWordGetGetRequest): Promise<QianchuanReportSearchWordGetV10Response> {
    const response = await this.openApiV10QianchuanReportSearchWordGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanReportSearchWordGetGetWithHttpInfo(request: OpenApiV10QianchuanReportSearchWordGetGetRequest): Promise<ApiResponse<QianchuanReportSearchWordGetV10Response>> {
