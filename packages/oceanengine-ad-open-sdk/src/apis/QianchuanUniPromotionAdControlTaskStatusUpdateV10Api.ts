...
export class QianchuanUniPromotionAdControlTaskStatusUpdateV10Api {
  ...
  async openApiV10QianchuanUniPromotionAdControlTaskStatusUpdatePost(request: QianchuanUniPromotionAdControlTaskStatusUpdateV10Request): Promise<QianchuanUniPromotionAdControlTaskStatusUpdateV10Response> {
    const response = await this.openApiV10QianchuanUniPromotionAdControlTaskStatusUpdatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniPromotionAdControlTaskStatusUpdatePostWithHttpInfo(request: QianchuanUniPromotionAdControlTaskStatusUpdateV10Request): Promise<ApiResponse<QianchuanUniPromotionAdControlTaskStatusUpdateV10Response>> {
