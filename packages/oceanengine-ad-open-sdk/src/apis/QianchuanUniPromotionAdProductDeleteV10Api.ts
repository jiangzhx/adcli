...
export class QianchuanUniPromotionAdProductDeleteV10Api {
  ...
  async openApiV10QianchuanUniPromotionAdProductDeletePost(request: QianchuanUniPromotionAdProductDeleteV10Request): Promise<QianchuanUniPromotionAdProductDeleteV10Response> {
    const response = await this.openApiV10QianchuanUniPromotionAdProductDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanUniPromotionAdProductDeletePostWithHttpInfo(request: QianchuanUniPromotionAdProductDeleteV10Request): Promise<ApiResponse<QianchuanUniPromotionAdProductDeleteV10Response>> {
