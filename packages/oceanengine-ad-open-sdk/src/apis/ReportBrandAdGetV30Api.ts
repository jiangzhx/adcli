...
export class ReportBrandAdGetV30Api {
  ...
  async openApiV30ReportBrandAdGetGet(request: OpenApiV30ReportBrandAdGetGetRequest): Promise<ReportBrandAdGetV30Response> {
    const response = await this.openApiV30ReportBrandAdGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ReportBrandAdGetGetWithHttpInfo(request: OpenApiV30ReportBrandAdGetGetRequest): Promise<ApiResponse<ReportBrandAdGetV30Response>> {
