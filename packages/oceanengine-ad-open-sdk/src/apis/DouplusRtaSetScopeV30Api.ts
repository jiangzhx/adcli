...
export class DouplusRtaSetScopeV30Api {
  ...
  async openApiV30DouplusRtaSetScopePost(request: DouplusRtaSetScopeV30Request): Promise<DouplusRtaSetScopeV30Response> {
    const response = await this.openApiV30DouplusRtaSetScopePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30DouplusRtaSetScopePostWithHttpInfo(request: DouplusRtaSetScopeV30Request): Promise<ApiResponse<DouplusRtaSetScopeV30Response>> {
