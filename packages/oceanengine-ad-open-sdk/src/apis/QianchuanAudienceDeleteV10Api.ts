...
export class QianchuanAudienceDeleteV10Api {
  ...
  async openApiV10QianchuanAudienceDeletePost(request: QianchuanAudienceDeleteV10Request): Promise<QianchuanAudienceDeleteV10Response> {
    const response = await this.openApiV10QianchuanAudienceDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanAudienceDeletePostWithHttpInfo(request: QianchuanAudienceDeleteV10Request): Promise<ApiResponse<QianchuanAudienceDeleteV10Response>> {
