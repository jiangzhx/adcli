...
export class QianchuanFinanceWalletGetV10Api {
  ...
  async openApiV10QianchuanFinanceWalletGetGet(request: OpenApiV10QianchuanFinanceWalletGetGetRequest): Promise<QianchuanFinanceWalletGetV10Response> {
    const response = await this.openApiV10QianchuanFinanceWalletGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanFinanceWalletGetGetWithHttpInfo(request: OpenApiV10QianchuanFinanceWalletGetGetRequest): Promise<ApiResponse<QianchuanFinanceWalletGetV10Response>> {
