...
export class KeywordCreateV2V2Api {
  ...
  async openApi2KeywordCreateV2Post(request: KeywordCreateV2V2Request): Promise<KeywordCreateV2V2Response> {
    const response = await this.openApi2KeywordCreateV2PostWithHttpInfo(request);
    return response.data;
  }

  async openApi2KeywordCreateV2PostWithHttpInfo(request: KeywordCreateV2V2Request): Promise<ApiResponse<KeywordCreateV2V2Response>> {
