...
export class DpaEbpProductDeleteV30Api {
  ...
  async openApiV30DpaEbpProductDeletePost(request: DpaEbpProductDeleteV30Request): Promise<DpaEbpProductDeleteV30Response> {
    const response = await this.openApiV30DpaEbpProductDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30DpaEbpProductDeletePostWithHttpInfo(request: DpaEbpProductDeleteV30Request): Promise<ApiResponse<DpaEbpProductDeleteV30Response>> {
