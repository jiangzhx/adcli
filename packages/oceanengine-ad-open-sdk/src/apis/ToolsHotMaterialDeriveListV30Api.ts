...
export class ToolsHotMaterialDeriveListV30Api {
  ...
  async openApiV30ToolsHotMaterialDeriveListGet(request: OpenApiV30ToolsHotMaterialDeriveListGetRequest): Promise<ToolsHotMaterialDeriveListV30Response> {
    const response = await this.openApiV30ToolsHotMaterialDeriveListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsHotMaterialDeriveListGetWithHttpInfo(request: OpenApiV30ToolsHotMaterialDeriveListGetRequest): Promise<ApiResponse<ToolsHotMaterialDeriveListV30Response>> {
