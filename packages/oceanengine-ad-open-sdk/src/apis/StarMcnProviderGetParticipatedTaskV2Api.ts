...
export class StarMcnProviderGetParticipatedTaskV2Api {
  ...
  async openApi2StarMcnProviderGetParticipatedTaskGet(request: OpenApi2StarMcnProviderGetParticipatedTaskGetRequest): Promise<StarMcnProviderGetParticipatedTaskV2Response> {
    const response = await this.openApi2StarMcnProviderGetParticipatedTaskGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2StarMcnProviderGetParticipatedTaskGetWithHttpInfo(request: OpenApi2StarMcnProviderGetParticipatedTaskGetRequest): Promise<ApiResponse<StarMcnProviderGetParticipatedTaskV2Response>> {
