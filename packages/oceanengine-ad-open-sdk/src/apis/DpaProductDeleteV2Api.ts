...
export class DpaProductDeleteV2Api {
  ...
  async openApi2DpaProductDeletePost(request: DpaProductDeleteV2Request): Promise<DpaProductDeleteV2Response> {
    const response = await this.openApi2DpaProductDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2DpaProductDeletePostWithHttpInfo(request: DpaProductDeleteV2Request): Promise<ApiResponse<DpaProductDeleteV2Response>> {
