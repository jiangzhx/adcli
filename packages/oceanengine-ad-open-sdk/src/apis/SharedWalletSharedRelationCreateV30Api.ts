...
export class SharedWalletSharedRelationCreateV30Api {
  ...
  async openApiV30SharedWalletSharedRelationCreatePost(request: SharedWalletSharedRelationCreateV30Request): Promise<SharedWalletSharedRelationCreateV30Response> {
    const response = await this.openApiV30SharedWalletSharedRelationCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30SharedWalletSharedRelationCreatePostWithHttpInfo(request: SharedWalletSharedRelationCreateV30Request): Promise<ApiResponse<SharedWalletSharedRelationCreateV30Response>> {
