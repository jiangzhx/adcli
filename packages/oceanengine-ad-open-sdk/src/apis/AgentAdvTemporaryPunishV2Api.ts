...
export class AgentAdvTemporaryPunishV2Api {
  ...
  async openApi2AgentAdvTemporaryPunishPost(request: AgentAdvTemporaryPunishV2Request): Promise<AgentAdvTemporaryPunishV2Response> {
    const response = await this.openApi2AgentAdvTemporaryPunishPostWithHttpInfo(request);
    return response.data;
  }

  async openApi2AgentAdvTemporaryPunishPostWithHttpInfo(request: AgentAdvTemporaryPunishV2Request): Promise<ApiResponse<AgentAdvTemporaryPunishV2Response>> {
