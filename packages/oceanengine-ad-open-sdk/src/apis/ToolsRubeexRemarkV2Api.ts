...
export interface OpenApi2ToolsRubeexRemarkGetRequest {
  advertiserId: number;
  projectId: number;
...
export class ToolsRubeexRemarkV2Api {
  ...
  async openApi2ToolsRubeexRemarkGet(request: OpenApi2ToolsRubeexRemarkGetRequest): Promise<ToolsRubeexRemarkV2Response> {
    const response = await this.openApi2ToolsRubeexRemarkGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2ToolsRubeexRemarkGetWithHttpInfo(request: OpenApi2ToolsRubeexRemarkGetRequest): Promise<ApiResponse<ToolsRubeexRemarkV2Response>> {
