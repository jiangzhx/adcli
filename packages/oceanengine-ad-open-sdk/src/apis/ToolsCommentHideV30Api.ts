...
export class ToolsCommentHideV30Api {
  ...
  async openApiV30ToolsCommentHidePost(request: ToolsCommentHideV30Request): Promise<ToolsCommentHideV30Response> {
    const response = await this.openApiV30ToolsCommentHidePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsCommentHidePostWithHttpInfo(request: ToolsCommentHideV30Request): Promise<ApiResponse<ToolsCommentHideV30Response>> {
