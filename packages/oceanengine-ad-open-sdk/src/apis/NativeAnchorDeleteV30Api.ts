...
export class NativeAnchorDeleteV30Api {
  ...
  async openApiV30NativeAnchorDeletePost(request: NativeAnchorDeleteV30Request): Promise<NativeAnchorDeleteV30Response> {
    const response = await this.openApiV30NativeAnchorDeletePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30NativeAnchorDeletePostWithHttpInfo(request: NativeAnchorDeleteV30Request): Promise<ApiResponse<NativeAnchorDeleteV30Response>> {
