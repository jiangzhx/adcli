...
export class ToolsEbpWechatAppletListV30Api {
  ...
  async openApiV30ToolsEbpWechatAppletListGet(request: OpenApiV30ToolsEbpWechatAppletListGetRequest): Promise<ToolsEbpWechatAppletListV30Response> {
    const response = await this.openApiV30ToolsEbpWechatAppletListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsEbpWechatAppletListGetWithHttpInfo(request: OpenApiV30ToolsEbpWechatAppletListGetRequest): Promise<ApiResponse<ToolsEbpWechatAppletListV30Response>> {
