...
export class DpaProductAvailablesV2Api {
  ...
  async openApi2DpaProductAvailablesGet(request: OpenApi2DpaProductAvailablesGetRequest): Promise<DpaProductAvailablesV2Response> {
    const response = await this.openApi2DpaProductAvailablesGetWithHttpInfo(request);
    return response.data;
  }

  async openApi2DpaProductAvailablesGetWithHttpInfo(request: OpenApi2DpaProductAvailablesGetRequest): Promise<ApiResponse<DpaProductAvailablesV2Response>> {
