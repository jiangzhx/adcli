...
export class ToolsEbpAppExtendCreateV30Api {
  ...
  async openApiV30ToolsEbpAppExtendCreatePost(request: ToolsEbpAppExtendCreateV30Request): Promise<ToolsEbpAppExtendCreateV30Response> {
    const response = await this.openApiV30ToolsEbpAppExtendCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApiV30ToolsEbpAppExtendCreatePostWithHttpInfo(request: ToolsEbpAppExtendCreateV30Request): Promise<ApiResponse<ToolsEbpAppExtendCreateV30Response>> {
