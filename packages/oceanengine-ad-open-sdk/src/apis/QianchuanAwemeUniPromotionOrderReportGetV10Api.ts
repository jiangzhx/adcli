...
export class QianchuanAwemeUniPromotionOrderReportGetV10Api {
  ...
  async openApiV10QianchuanAwemeUniPromotionOrderReportGetGet(request: OpenApiV10QianchuanAwemeUniPromotionOrderReportGetGetRequest): Promise<QianchuanAwemeUniPromotionOrderReportGetV10Response> {
    const response = await this.openApiV10QianchuanAwemeUniPromotionOrderReportGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanAwemeUniPromotionOrderReportGetGetWithHttpInfo(request: OpenApiV10QianchuanAwemeUniPromotionOrderReportGetGetRequest): Promise<ApiResponse<QianchuanAwemeUniPromotionOrderReportGetV10Response>> {
