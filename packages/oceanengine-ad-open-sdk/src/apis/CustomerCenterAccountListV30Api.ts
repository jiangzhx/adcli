...
export class CustomerCenterAccountListV30Api {
  ...
  async openApiV30CustomerCenterAccountListGet(request: OpenApiV30CustomerCenterAccountListGetRequest): Promise<CustomerCenterAccountListV30Response> {
    const response = await this.openApiV30CustomerCenterAccountListGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV30CustomerCenterAccountListGetWithHttpInfo(request: OpenApiV30CustomerCenterAccountListGetRequest): Promise<ApiResponse<CustomerCenterAccountListV30Response>> {
