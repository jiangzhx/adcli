...
export class EbpAdvertiserTaskCreateV2Api {
  ...
  async openApi2EbpAdvertiserTaskCreatePost(request: EbpAdvertiserTaskCreateV2Request): Promise<EbpAdvertiserTaskCreateV2Response> {
    const response = await this.openApi2EbpAdvertiserTaskCreatePostWithHttpInfo(request);
    return response.data;
  }

  async openApi2EbpAdvertiserTaskCreatePostWithHttpInfo(request: EbpAdvertiserTaskCreateV2Request): Promise<ApiResponse<EbpAdvertiserTaskCreateV2Response>> {
