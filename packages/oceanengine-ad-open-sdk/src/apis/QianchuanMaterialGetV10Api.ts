...
export class QianchuanMaterialGetV10Api {
  ...
  async openApiV10QianchuanMaterialGetGet(request: OpenApiV10QianchuanMaterialGetGetRequest): Promise<QianchuanMaterialGetV10Response> {
    const response = await this.openApiV10QianchuanMaterialGetGetWithHttpInfo(request);
    return response.data;
  }

  async openApiV10QianchuanMaterialGetGetWithHttpInfo(request: OpenApiV10QianchuanMaterialGetGetRequest): Promise<ApiResponse<QianchuanMaterialGetV10Response>> {
