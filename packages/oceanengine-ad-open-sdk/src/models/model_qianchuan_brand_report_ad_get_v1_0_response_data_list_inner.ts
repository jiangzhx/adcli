// 由 oceanengine/ad_open_sdk_go models/model_qianchuan_brand_report_ad_get_v1_0_response_data_list_inner.go 生成
// 不要手动编辑。

export interface QianchuanBrandReportAdGetV10ResponseDataListInner {
  ad_id?: number | string;
