// 由 oceanengine/ad_open_sdk_go models/model_tools_privative_word_promotion_update_v3_0_response_data.go 生成
// 不要手动编辑。

import type { ToolsPrivativeWordPromotionUpdateV30ResponseDataErrorListInner } from "../models/index";
