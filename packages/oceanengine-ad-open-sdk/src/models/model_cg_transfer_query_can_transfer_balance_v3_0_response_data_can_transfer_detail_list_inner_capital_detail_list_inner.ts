// 由 oceanengine/ad_open_sdk_go models/model_cg_transfer_query_can_transfer_balance_v3_0_response_data_can_transfer_detail_list_inner_capital_detail_list_inner.go 生成
// 不要手动编辑。
