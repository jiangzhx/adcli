// 由 oceanengine/ad_open_sdk_go models/model_promotion_list_v3_0_response_data_list_inner_brand_info.go 生成
// 不要手动编辑。

export interface PromotionListV30ResponseDataListInnerBrandInfo {
