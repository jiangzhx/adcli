// 由 oceanengine/ad_open_sdk_go models/model_brand_order_list_v3_0_response_data_orders_inner.go 生成
// 不要手动编辑。

import type { BrandOrderListV30DataOrdersAdForm, BrandOrderListV30DataOrdersAdvancedCreativeType, BrandOrderListV30DataOrdersAdvancedOption, BrandOrderListV30DataOrdersAppOrigin, BrandOrderListV30DataOrdersAuditStatus, BrandOrderListV30DataOrdersClassify, BrandOrderListV30DataOrdersGdSendType, BrandOrderListV30DataOrdersPricingType, BrandOrderListV30DataOrdersProType, BrandOrderListV30DataOrdersStatus, BrandOrderListV30ResponseDataOrdersInnerAdInfosInner, BrandOrderListV30ResponseDataOrdersInnerAudienceInfo, BrandOrderListV30ResponseDataOrdersInnerBookingQuantityInfo, BrandOrderListV30ResponseDataOrdersInnerFailInfoListInner, BrandOrderListV30ResponseDataOrdersInnerFrequencyInfo, BrandOrderListV30ResponseDataOrdersInnerMagazinePriceInfo, BrandOrderListV30ResponseDataOrdersInnerMerchantIntention, BrandOrderListV30ResponseDataOrdersInnerPolicy, BrandOrderListV30ResponseDataOrdersInnerScheduleInfo } from "../models/index";
...
export interface BrandOrderListV30ResponseDataOrdersInner {
  ...
  advanced_option?: BrandOrderListV30DataOrdersAdvancedOption;
