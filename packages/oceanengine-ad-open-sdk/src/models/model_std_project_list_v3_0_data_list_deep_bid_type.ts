// 由 oceanengine/ad_open_sdk_go models/model_std_project_list_v3_0_data_list_deep_bid_type.go 生成
// 不要手动编辑。

export const StdProjectListV30DataListDeepBidType = {
  ALI_FL: "ALI_FL",
...
export type StdProjectListV30DataListDeepBidType = typeof StdProjectListV30DataListDeepBidType[keyof typeof StdProjectListV30DataListDeepBidType];
