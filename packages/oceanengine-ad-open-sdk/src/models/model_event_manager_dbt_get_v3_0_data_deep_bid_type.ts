// 由 oceanengine/ad_open_sdk_go models/model_event_manager_dbt_get_v3_0_data_deep_bid_type.go 生成
// 不要手动编辑。

export const EventManagerDbtGetV30DataDeepBidType = {
  ALI_FL: "ALI_FL",
...
export type EventManagerDbtGetV30DataDeepBidType = typeof EventManagerDbtGetV30DataDeepBidType[keyof typeof EventManagerDbtGetV30DataDeepBidType];
