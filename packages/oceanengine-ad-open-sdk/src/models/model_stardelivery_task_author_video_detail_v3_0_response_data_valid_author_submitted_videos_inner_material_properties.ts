// 由 oceanengine/ad_open_sdk_go models/model_stardelivery_task_author_video_detail_v3_0_response_data_valid_author_submitted_videos_inner_material_properties.go 生成
// 不要手动编辑。
