// 由 oceanengine/ad_open_sdk_go models/model_cg_transfer_wallet_transfer_list_v3_0_response_data_record_list_inner_transfer_capital_record_list_inner.go 生成
// 不要手动编辑。
