// Generated from tencentad/marketing-api-go-sdk pkg/api/v3/api_marketing_target_asset_categories.go
...
export class MarketingTargetAssetCategoriesApi {
  ...
  async get(request: MarketingTargetAssetCategoriesApiGetRequest): Promise<MarketingTargetAssetCategoriesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: MarketingTargetAssetCategoriesApiGetRequest): Promise<ApiResponse<MarketingTargetAssetCategoriesGetResponseData>> {
