// Generated from tencentad/marketing-api-go-sdk pkg/api/v3/api_creative_template_list.go
...
export class CreativeTemplateListApi {
  ...
  async get(request: CreativeTemplateListApiGetRequest): Promise<CreativeTemplateListGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: CreativeTemplateListApiGetRequest): Promise<ApiResponse<CreativeTemplateListGetResponseData>> {
