...
export class MarketingTargetAssetPropertyValuesApi {
  ...
  async get(request: MarketingTargetAssetPropertyValuesApiGetRequest): Promise<MarketingTargetAssetPropertyValuesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: MarketingTargetAssetPropertyValuesApiGetRequest): Promise<ApiResponse<MarketingTargetAssetPropertyValuesGetResponseData>> {
