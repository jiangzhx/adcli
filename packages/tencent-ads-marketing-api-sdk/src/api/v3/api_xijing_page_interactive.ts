// Generated from tencentad/marketing-api-go-sdk pkg/api/v3/api_xijing_page_interactive.go
...
export class XijingPageInteractiveApi {
  ...
  async add(request: XijingPageInteractiveApiAddRequest): Promise<XijingPageInteractiveAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: XijingPageInteractiveApiAddRequest): Promise<ApiResponse<XijingPageInteractiveAddResponseData>> {
    ...
    return this.apiClient.requestWithHttpInfo<XijingPageInteractiveAddResponseData>({
      method: "POST",
