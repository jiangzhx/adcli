// Generated from tencentad/marketing-api-go-sdk pkg/model/v3/model_marketing_target_type.go
// Do not edit manually.

export const MarketingTargetType = {
  ...
  WECHAT_STORE_PRODUCT: "MARKETING_TARGET_TYPE_WECHAT_STORE_PRODUCT",
  APP_HARMONY: "MARKETING_TARGET_TYPE_APP_HARMONY",
  WECHAT_STORE_PRODUCT_SET: "MARKETING_TARGET_TYPE_WECHAT_STORE_PRODUCT_SET",
  PRODUCT_AGGREGATION_PAGE: "MARKETING_TARGET_TYPE_PRODUCT_AGGREGATION_PAGE",
  WECHAT_STORE: "MARKETING_TARGET_TYPE_WECHAT_STORE",
  RESALE_AND_COMMERCIAL_LAND: "MARKETING_TARGET_TYPE_RESALE_AND_COMMERCIAL_LAND",
  VIDEO_PROGRAM: "MARKETING_TARGET_TYPE_VIDEO_PROGRAM",
  FUN_TEST: "MARKETING_TARGET_TYPE_FUN_TEST",
  MATERNITY_PARENTING: "MARKETING_TARGET_TYPE_MATERNITY_PARENTING",
  LEISURE_ENTERTAINMENT: "MARKETING_TARGET_TYPE_LEISURE_ENTERTAINMENT",
  MEDICAL_INSTITUTION: "MARKETING_TARGET_TYPE_MEDICAL_INSTITUTION",
  WECHAT_CHANNELS_ACTIVITY: "MARKETING_TARGET_TYPE_WECHAT_CHANNELS_ACTIVITY",
} as const;
