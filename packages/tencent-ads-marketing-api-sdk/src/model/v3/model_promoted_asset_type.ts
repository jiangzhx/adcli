// Generated from tencentad/marketing-api-go-sdk pkg/model/v3/model_promoted_asset_type.go
// Do not edit manually.

export const PromotedAssetType = {
  ...
  CAR_ECOLOGY: "PROMOTED_ASSET_TYPE_CAR_ECOLOGY",
  WECHAT_STORE_PRODUCT: "PROMOTED_ASSET_TYPE_WECHAT_STORE_PRODUCT",
  APP_HARMONY: "PROMOTED_ASSET_TYPE_APP_HARMONY",
  WECHAT_STORE_PRODUCT_SET: "PROMOTED_ASSET_TYPE_WECHAT_STORE_PRODUCT_SET",
  PRODUCT_AGGREGATION_PAGE: "PROMOTED_ASSET_TYPE_PRODUCT_AGGREGATION_PAGE",
  WECHAT_STORE: "PROMOTED_ASSET_TYPE_WECHAT_STORE",
  RESALE_AND_COMMERCIAL_LAND: "PROMOTED_ASSET_TYPE_RESALE_AND_COMMERCIAL_LAND",
  VIDEO_PROGRAM: "PROMOTED_ASSET_TYPE_VIDEO_PROGRAM",
  FUN_TEST: "PROMOTED_ASSET_TYPE_FUN_TEST",
  MATERNITY_PARENTING: "PROMOTED_ASSET_TYPE_MATERNITY_PARENTING",
  LEISURE_ENTERTAINMENT: "PROMOTED_ASSET_TYPE_LEISURE_ENTERTAINMENT",
  MEDICAL_INSTITUTION: "PROMOTED_ASSET_TYPE_MEDICAL_INSTITUTION",
  WECHAT_CHANNELS_ACTIVITY: "PROMOTED_ASSET_TYPE_WECHAT_CHANNELS_ACTIVITY",
} as const;
