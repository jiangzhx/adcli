...
export class V3RealtimeCostApi {
  ...
  async get(request: V3RealtimeCostApiGetRequest): Promise<RealtimeCostGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3RealtimeCostApiGetRequest): Promise<ApiResponse<RealtimeCostGetResponseData>> {
