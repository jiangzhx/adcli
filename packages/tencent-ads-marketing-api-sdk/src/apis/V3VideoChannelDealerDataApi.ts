...
export class V3VideoChannelDealerDataApi {
  ...
  async get(request: V3VideoChannelDealerDataApiGetRequest): Promise<VideoChannelDealerDataGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3VideoChannelDealerDataApiGetRequest): Promise<ApiResponse<VideoChannelDealerDataGetResponseData>> {
