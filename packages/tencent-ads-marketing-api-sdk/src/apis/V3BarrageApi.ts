...
export class V3BarrageApi {
  ...
  async add(request: V3BarrageApiAddRequest): Promise<BarrageAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3BarrageApiAddRequest): Promise<ApiResponse<BarrageAddResponseData>> {
  ...
  async get(request: V3BarrageApiGetRequest): Promise<BarrageGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3BarrageApiGetRequest): Promise<ApiResponse<BarrageGetResponseData>> {
