...
export class V3BusinessUnitListApi {
  ...
  async get(request: V3BusinessUnitListApiGetRequest): Promise<BusinessUnitListGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3BusinessUnitListApiGetRequest): Promise<ApiResponse<BusinessUnitListGetResponseData>> {
