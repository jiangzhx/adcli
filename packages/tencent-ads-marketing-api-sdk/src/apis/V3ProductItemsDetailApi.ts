...
export class V3ProductItemsDetailApi {
  ...
  async get(request: V3ProductItemsDetailApiGetRequest): Promise<ProductItemsDetailGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3ProductItemsDetailApiGetRequest): Promise<ApiResponse<ProductItemsDetailGetResponseData>> {
