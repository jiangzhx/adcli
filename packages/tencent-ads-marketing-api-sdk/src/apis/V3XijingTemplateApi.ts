...
export class V3XijingTemplateApi {
  ...
  async get(request: V3XijingTemplateApiGetRequest): Promise<XijingTemplateGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3XijingTemplateApiGetRequest): Promise<ApiResponse<XijingTemplateGetResponseData>> {
