...
export class V3FundsApi {
  ...
  async get(request: V3FundsApiGetRequest): Promise<FundsGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3FundsApiGetRequest): Promise<ApiResponse<FundsGetResponseData>> {
