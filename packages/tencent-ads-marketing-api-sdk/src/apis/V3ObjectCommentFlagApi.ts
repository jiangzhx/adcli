...
export class V3ObjectCommentFlagApi {
  ...
  async update(request: V3ObjectCommentFlagApiUpdateRequest): Promise<unknown> {
    const response = await this.updateWithHttpInfo(request);
    return response.data;
  }

  async updateWithHttpInfo(request: V3ObjectCommentFlagApiUpdateRequest): Promise<ApiResponse<unknown>> {
