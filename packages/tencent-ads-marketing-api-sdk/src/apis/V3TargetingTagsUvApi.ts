...
export class V3TargetingTagsUvApi {
  ...
  async get(request: V3TargetingTagsUvApiGetRequest): Promise<TargetingTagsUvGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3TargetingTagsUvApiGetRequest): Promise<ApiResponse<TargetingTagsUvGetResponseData>> {
