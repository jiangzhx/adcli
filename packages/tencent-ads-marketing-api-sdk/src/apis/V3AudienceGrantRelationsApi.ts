...
export class V3AudienceGrantRelationsApi {
  ...
  async add(request: V3AudienceGrantRelationsApiAddRequest): Promise<unknown> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3AudienceGrantRelationsApiAddRequest): Promise<ApiResponse<unknown>> {
  ...
  async get(request: V3AudienceGrantRelationsApiGetRequest): Promise<AudienceGrantRelationsGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3AudienceGrantRelationsApiGetRequest): Promise<ApiResponse<AudienceGrantRelationsGetResponseData>> {
