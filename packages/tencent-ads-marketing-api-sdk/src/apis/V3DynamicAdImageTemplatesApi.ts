...
export class V3DynamicAdImageTemplatesApi {
  ...
  async get(request: V3DynamicAdImageTemplatesApiGetRequest): Promise<DynamicAdImageTemplatesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3DynamicAdImageTemplatesApiGetRequest): Promise<ApiResponse<DynamicAdImageTemplatesGetResponseData>> {
