...
export class V3DynamicAdVideoApi {
  ...
  async add(request: V3DynamicAdVideoApiAddRequest): Promise<DynamicAdVideoAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3DynamicAdVideoApiAddRequest): Promise<ApiResponse<DynamicAdVideoAddResponseData>> {
  ...
  async get(request: V3DynamicAdVideoApiGetRequest): Promise<DynamicAdVideoGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3DynamicAdVideoApiGetRequest): Promise<ApiResponse<DynamicAdVideoGetResponseData>> {
