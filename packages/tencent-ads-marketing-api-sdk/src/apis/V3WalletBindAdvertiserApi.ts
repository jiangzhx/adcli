...
export class V3WalletBindAdvertiserApi {
  ...
  async add(request: V3WalletBindAdvertiserApiAddRequest): Promise<unknown> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3WalletBindAdvertiserApiAddRequest): Promise<ApiResponse<unknown>> {
