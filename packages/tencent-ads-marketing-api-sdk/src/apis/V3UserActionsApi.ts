...
export class V3UserActionsApi {
  ...
  async add(request: V3UserActionsApiAddRequest): Promise<unknown> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3UserActionsApiAddRequest): Promise<ApiResponse<unknown>> {
