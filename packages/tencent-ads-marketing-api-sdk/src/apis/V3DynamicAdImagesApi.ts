...
export class V3DynamicAdImagesApi {
  ...
  async add(request: V3DynamicAdImagesApiAddRequest): Promise<DynamicAdImagesAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3DynamicAdImagesApiAddRequest): Promise<ApiResponse<DynamicAdImagesAddResponseData>> {
  ...
  async get(request: V3DynamicAdImagesApiGetRequest): Promise<DynamicAdImagesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3DynamicAdImagesApiGetRequest): Promise<ApiResponse<DynamicAdImagesGetResponseData>> {
