...
export class V3DynamicAdVideoTemplatesApi {
  ...
  async get(request: V3DynamicAdVideoTemplatesApiGetRequest): Promise<DynamicAdVideoTemplatesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3DynamicAdVideoTemplatesApiGetRequest): Promise<ApiResponse<DynamicAdVideoTemplatesGetResponseData>> {
