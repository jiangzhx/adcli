...
export class V3CustomAudienceFilesApi {
  ...
  async add(request: V3CustomAudienceFilesApiAddRequest): Promise<CustomAudienceFilesAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3CustomAudienceFilesApiAddRequest): Promise<ApiResponse<CustomAudienceFilesAddResponseData>> {
  ...
  async get(request: V3CustomAudienceFilesApiGetRequest): Promise<CustomAudienceFilesGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3CustomAudienceFilesApiGetRequest): Promise<ApiResponse<CustomAudienceFilesGetResponseData>> {
    if (request.accountId == null) {
