...
export class V3XijingPageInteractiveApi {
  ...
  async add(request: V3XijingPageInteractiveApiAddRequest): Promise<XijingPageInteractiveAddResponseData> {
    const response = await this.addWithHttpInfo(request);
    return response.data;
  }

  async addWithHttpInfo(request: V3XijingPageInteractiveApiAddRequest): Promise<ApiResponse<XijingPageInteractiveAddResponseData>> {
