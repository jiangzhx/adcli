...
export class V3GameFeatureTagsApi {
  ...
  async get(request: V3GameFeatureTagsApiGetRequest): Promise<GameFeatureTagsGetResponseData> {
    const response = await this.getWithHttpInfo(request);
    return response.data;
  }

  async getWithHttpInfo(request: V3GameFeatureTagsApiGetRequest): Promise<ApiResponse<GameFeatureTagsGetResponseData>> {
