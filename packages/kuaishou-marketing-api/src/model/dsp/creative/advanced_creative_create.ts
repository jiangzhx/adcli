// Generated from github.com/bububa/kwai-marketing-api/model/dsp/creative/advanced_creative_create.go
...
export interface AdvancedCreativeCreateRequestInit {
...
export class AdvancedCreativeCreateRequest implements PostRequest, AdvancedCreativeCreateRequestInit {
  advertiser_id?: KuaishouId;
  unit_id?: KuaishouId;
  package_name?: string;
  sticker_styles?: number[];
  ...
  constructor(init: AdvancedCreativeCreateRequestInit = {}) {
...
export interface AdvancedCreativeCreateResponse {
  unit_id?: KuaishouId;
}
