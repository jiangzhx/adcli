// Generated from github.com/bububa/kwai-marketing-api/model/appcenter/app/update_android.go
...
export interface UpdateAndroidRequestInit {
...
export class UpdateAndroidRequest implements PostRequest, UpdateAndroidRequestInit {
  advertiser_id?: KuaishouId;
  app_info?: App;
  app_privacy_info?: AppPrivacyInfo;
  package_info?: PackageInfo;

  constructor(init: UpdateAndroidRequestInit = {}) {
