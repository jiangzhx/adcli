// Generated from github.com/bububa/kwai-marketing-api/model/creative/advanced_program_create_request.go
...
export interface AdvancedProgramCreateRequestInit {
...
export class AdvancedProgramCreateRequest implements PostRequest, AdvancedProgramCreateRequestInit {
  advertiser_id?: KuaishouId;
  unit_id?: KuaishouId;
  package_name?: string;
  horizontal_photo_ids?: string[];
  ...
  constructor(init: AdvancedProgramCreateRequestInit = {}) {
  ...
  path() {
    return "creative/advanced/program/create";
  }
