import { runGoPortWorkflow } from "../../src/oceanengine/go-workflow";
import type { GoPortWorkflowResult } from "../../src/oceanengine/go-workflow";
...
if (isCliEntry) {
  ...
  if (!goSdkRoot) {
    console.error("Usage: bun run packages/codegen/scripts/oceanengine/generate-from-go-sdk.ts /path/to/ad_open_sdk_go [outputDir]");
    process.exit(1);
  }
