...
describe("monorepo package shape", () => {
  test("registers SDK packages as root workspaces", () => {
    ...
    expect(pkg.dependencies["@jiangzhx/oceanengine-ad-open-sdk"]).toBe("1.1.87-port.6");
    expect(pkg.dependencies["@jiangzhx/tencent-ads-marketing-api-sdk"]).toBe("1.7.84-port.2");
